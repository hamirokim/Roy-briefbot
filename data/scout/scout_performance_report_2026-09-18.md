...
- POSITIVE: n=54, avgD20=-3.75, avgAlphaD20=2.58, winner=0.278, failed_fast=0.667, bought=0
- BULL: n=22, avgD20=5.71, avgAlphaD20=4.04, winner=0.636, failed_fast=0.318, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.24, avgD20=4.43, alphaD20=4.6
- pre_entry_v1: n=56/60, avgD5=-1.17, avgD10=-2.09, avgD20=-6.69, alphaD20=-4.32
- us_precision_v1: n=74/77, avgD5=0.77, avgD10=2.08, avgD20=2.44, alphaD20=1.49

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=126/291, target=76, stop=50, late=81, avgR=0.01
- confirmed_swings_v1: resolved=193/663, target=80, stop=113, late=52, avgR=-0.24
- prominence_reaction_v2: resolved=143/291, target=83, stop=60, late=80, avgR=-0.03
- rolling_extrema_v1: resolved=73/291, target=9, stop=64, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=288/294, alpha={'d5': 0.34, 'd10': 0.53, 'd20': 4.46}, positiveAlpha={'d5': 0.558, 'd10': 0.56, 'd20': 0.594}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.03, 'd20': 4.6}, positiveAlpha={'d5': 0.514, 'd10': 0.595, 'd20': 0.576}
- shadow:pre_entry_v1: n=56/60, alpha={'d5': -0.6, 'd10': -1.46, 'd20': -4.32}, positiveAlpha={'d5': 0.364, 'd10': 0.433, 'd20': 0.333}
- shadow:us_precision_v1: n=74/77, alpha={'d5': 0.47, 'd10': 0.91, 'd20': 1.49}, positiveAlpha={'d5': 0.476, 'd10': 0.556, 'd20': 0.562}

## Decision And Abstention Audit
- snapshots: 98
- abstentions: {'MISSED_OPPORTUNITY': 41, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 802
- avg D20 opportunity cost: 7.68
- avg D20 ex-post upper-bound gap: 29.2
