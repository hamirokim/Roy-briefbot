...
- date: 2026-07-07
- evaluated candidates: 102 / 105
- actually bought: 0
- avg D20 return: -1.58
- verdicts: {'FAILED_FAST': 48, 'WINNER': 19, 'WATCH': 12, 'PENDING': 23}

## Aggregates

### by_lane
- strength: n=59, avgD20=-1.06, winner=0.237, failed_fast=0.424, bought=0
- pullback: n=28, avgD20=-7.62, winner=0.107, failed_fast=0.679, bought=0
- left_side: n=15, avgD20=1.15, winner=0.133, failed_fast=0.267, bought=0

### by_lane_status
- STRONG_PASS: n=72, avgD20=-0.07, winner=0.236, failed_fast=0.486, bought=0
- PASS: n=14, avgD20=-33.1, winner=0.0, failed_fast=0.643, bought=0
- STAGE2_PASS: n=11, avgD20=1.15, winner=0.091, failed_fast=0.273, bought=0
...
### by_theme_industry
- SUPPORT: n=51, avgD20=1.09, winner=0.333, failed_fast=0.353, bought=0
- NO_MAPPING: n=32, avgD20=-10.53, winner=0.0, failed_fast=0.781, bought=0
- STRONG_SUPPORT: n=16, avgD20=-9.9, winner=0.062, failed_fast=0.312, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=41, avgD20=-1.4, winner=0.268, failed_fast=0.366, bought=0
- QUALITY_SUPPORT: n=29, avgD20=0.66, winner=0.207, failed_fast=0.448, bought=0
- not_checked: n=17, avgD20=None, winner=0.059, failed_fast=0.588, bought=0
...
### by_catalyst
- unknown: n=41, avgD20=-0.1, winner=0.268, failed_fast=0.439, bought=0
- POSITIVE_REVALUATION: n=30, avgD20=-5.43, winner=0.167, failed_fast=0.467, bought=0
- NOISE: n=26, avgD20=5.45, winner=0.115, failed_fast=0.423, bought=0
- NO_DATA: n=5, avgD20=None, winner=0.0, failed_fast=1.0, bought=0

## LLM Override Comparison
- counts: dropped=7, added=17, kept=88
- avg D5: dropped=-2.51, added=-1.67, kept=-0.7
- avg D20: dropped=-12.14, added=-2.17, kept=-1.44
...
- 2026-06-13 MNST WINNER D5=0.49 D20=None MFE=6.11 MAE=-2.43 lane=strength:STRONG_PASS
- 2026-06-19 ALAB FAILED_FAST D5=3.71 D20=None MFE=13.61 MAE=-15.28 lane=strength:STRONG_PASS
- 2026-06-24 NUVL WATCH D5=0.02 D20=None MFE=0.18 MAE=-0.12 lane=strength:STRONG_PASS
- 2026-06-27 DELL PENDING D5=None D20=None MFE=5.77 MAE=-8.67 lane=pullback:PASS
...
- 2026-06-18 REGN WATCH D5=3.76 D20=None MFE=7.87 MAE=-2.47 lane=left_side:STAGE2_PASS
...
- 2026-06-24 AMGN WATCH D5=2.82 D20=None MFE=6.75 MAE=-1.55 lane=pullback:PASS
- 2026-06-25 KT WATCH D5=-0.67 D20=None MFE=1.97 MAE=-3.82 lane=left_side:STAGE2_PASS
- 2026-06-27 003230.KS FAILED_FAST D5=-5.34 D20=None MFE=5.6 MAE=-9.48 lane=left_side:STAGE2_PASS
- 2026-07-02 IBM PENDING D5=None D20=None MFE=3.9 MAE=-2.5 lane=pullback:WAIT
...
- 2026-06-05 IRM FAILED_FAST D20=None MFE=8.04 MAE=-7.9 bought=False lane=strength catalyst=NOISE
...
- 2026-06-09 AD FAILED_FAST D20=None MFE=3.52 MAE=-31.52 bought=False lane=left_side catalyst=POSITIVE_REVALUATION
...
- 2026-06-13 CSCO WATCH D20=None MFE=2.26 MAE=-6.88 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-06-15 MNST WINNER D20=None MFE=6.11 MAE=-2.43 bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-06-16 010950.KS FAILED_FAST D20=None MFE=2.45 MAE=-20.77 bought=False lane=pullback catalyst=NO_DATA
...
- 2026-06-18 080220.KQ FAILED_FAST D20=None MFE=17.25 MAE=-29.14 bought=False lane=strength catalyst=NOISE
- 2026-06-18 034220.KS FAILED_FAST D20=None MFE=4.8 MAE=-22.91 bought=False lane=pullback catalyst=
- 2026-06-18 REGN WATCH D20=None MFE=7.87 MAE=-2.47 bought=False lane=left_side catalyst=NOISE
...
- 2026-06-19 TRGP WATCH D20=None MFE=4.19 MAE=-3.21 bought=False lane=strength catalyst=
- 2026-06-20 420770.KQ FAILED_FAST D20=None MFE=29.4 MAE=-12.0 bought=False lane=strength catalyst=
...
- 2026-06-22 440110.KQ FAILED_FAST D20=None MFE=2.5 MAE=-38.83 bought=False lane=pullback catalyst=
- 2026-06-22 003550.KS FAILED_FAST D20=None MFE=4.19 MAE=-15.2 bought=False lane=pullback catalyst=NO_DATA
- 2026-06-23 080220.KQ FAILED_FAST D20=None MFE=20.31 MAE=-24.73 bought=False lane=strength catalyst=NO_DATA
...
- 2026-06-24 GH WINNER D20=None MFE=26.19 MAE=-3.18 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-06-24 AMGN WATCH D20=None MFE=6.75 MAE=-1.55 bought=False lane=pullback catalyst=POSITIVE_REVALUATION
- 2026-06-25 KT WATCH D20=None MFE=1.97 MAE=-3.82 bought=False lane=left_side catalyst=POSITIVE_REVALUATION
- 2026-06-25 WMB FAILED_FAST D20=None MFE=1.9 MAE=-6.99 bought=False lane=strength catalyst=
- 2026-06-25 TRGP FAILED_FAST D20=None MFE=0.78 MAE=-6.37 bought=False lane=strength catalyst=
...
- 2026-06-26 ROKU WATCH D20=None MFE=5.6 MAE=-0.77 bought=False lane=strength catalyst=
- 2026-06-27 NU PENDING D20=None MFE=7.08 MAE=-1.45 bought=False lane=left_side catalyst=
- 2026-06-27 APD PENDING D20=None MFE=16.04 MAE=-0.46 bought=False lane=pullback catalyst=POSITIVE_REVALUATION
...
- 2026-06-29 ASML PENDING D20=None MFE=6.21 MAE=-7.17 bought=False lane=strength catalyst=
- 2026-06-29 FTNT PENDING D20=None MFE=5.24 MAE=-3.02 bought=False lane=strength catalyst=NOISE
- 2026-06-30 TSM PENDING D20=None MFE=0.3 MAE=-10.07 bought=False lane=strength catalyst=NOISE
- 2026-06-30 CRWD PENDING D20=None MFE=9.8 MAE=-4.08 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-06-30 PENG PENDING D20=None MFE=1.79 MAE=-22.87 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-07-01 009150.KS PENDING D20=None MFE=3.95 MAE=-21.36 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-07-01 TIGO PENDING D20=None MFE=5.81 MAE=-2.75 bought=False lane=strength catalyst=
- 2026-07-01 MRVL PENDING D20=None MFE=7.52 MAE=-12.81 bought=False lane=strength catalyst=NOISE
- 2026-07-02 F PENDING D20=None MFE=4.79 MAE=-1.05 bought=False lane=pullback catalyst=NOISE
- 2026-07-02 IBM PENDING D20=None MFE=3.9 MAE=-2.5 bought=False lane=pullback catalyst=NOISE
- 2026-07-02 098460.KQ PENDING D20=None MFE=10.29 MAE=-8.43 bought=False lane=pullback catalyst=
- 2026-07-03 DDOG PENDING D20=None MFE=2.93 MAE=-2.75 bought=False lane=strength catalyst=
- 2026-07-03 OKTA PENDING D20=None MFE=0.17 MAE=-4.07 bought=False lane=strength catalyst=
- 2026-07-03 PANW PENDING D20=None MFE=2.98 MAE=-5.55 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-07-04 001800.KS PENDING D20=None MFE=0.97 MAE=-2.14 bought=False lane=pullback catalyst=
- 2026-07-04 A PENDING D20=None MFE=0.52 MAE=-1.95 bought=False lane=left_side catalyst=POSITIVE_REVALUATION
- 2026-07-04 069960.KS PENDING D20=None MFE=3.91 MAE=-6.52 bought=False lane=strength catalyst=NOISE
- 2026-07-06 003230.KS PENDING D20=None MFE=2.64 MAE=-4.37 bought=False lane=left_side catalyst=NOISE
- 2026-07-06 PUK PENDING D20=None MFE=0.02 MAE=-1.24 bought=False lane=left_side catalyst=NOISE
- 2026-07-06 029780.KS PENDING D20=None MFE=3.18 MAE=-1.13 bought=False lane=left_side catalyst=NOISE
- 2026-07-07 CPNG PENDING D20=None MFE=None MAE=None bought=False lane=left_side catalyst=
- 2026-07-07 F PENDING D20=None MFE=None MAE=None bought=False lane=pullback catalyst=POSITIVE_REVALUATION
- 2026-07-07 FLEX PENDING D20=None MFE=None MAE=None bought=False lane=pullback catalyst=
