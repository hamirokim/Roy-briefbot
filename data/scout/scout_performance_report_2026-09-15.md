...
### by_theme_industry
- SUPPORT: n=66, avgD20=1.36, avgAlphaD20=1.14, winner=0.53, failed_fast=0.364, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=56, avgD20=2.59, avgAlphaD20=3.69, winner=0.464, failed_fast=0.446, bought=0
...
- NEGATIVE: n=44, avgD20=-6.68, avgAlphaD20=0.48, winner=0.341, failed_fast=0.591, bought=0
- BULL: n=23, avgD20=5.71, avgAlphaD20=4.04, winner=0.609, failed_fast=0.304, bought=0
- MIXED: n=14, avgD20=-0.7, avgAlphaD20=-2.49, winner=0.429, failed_fast=0.571, bought=0
...
- NONE: n=131/131, alpha={'d5': 0.1, 'd10': -0.43, 'd20': 1.35}, positiveAlpha={'d5': 0.531, 'd10': 0.538, 'd20': 0.554}
- SUPPORT: n=4/4, alpha={'d5': 6.87, 'd10': 13.52, 'd20': 9.77}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}

## Precision Shadow Comparison
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.53, avgD20=6.94, alphaD20=6.55
- pre_entry_v1: n=48/54, avgD5=-0.96, avgD10=-1.59, avgD20=None, alphaD20=None
- us_precision_v1: n=67/71, avgD5=1.39, avgD10=2.29, avgD20=2.77, alphaD20=1.35

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=107/260, target=68, stop=39, late=74, avgR=0.07
- confirmed_swings_v1: resolved=161/575, target=67, stop=94, late=48, avgR=-0.26
- prominence_reaction_v2: resolved=119/260, target=71, stop=48, late=74, avgR=0.0
- rolling_extrema_v1: resolved=52/260, target=6, stop=46, late=1, avgR=-0.83

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=278/285, alpha={'d5': 0.38, 'd10': 0.67, 'd20': 5.0}, positiveAlpha={'d5': 0.552, 'd10': 0.573, 'd20': 0.605}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.27, 'd20': 6.55}, positiveAlpha={'d5': 0.514, 'd10': 0.611, 'd20': 0.615}
- shadow:pre_entry_v1: n=48/54, alpha={'d5': -0.64, 'd10': -1.19, 'd20': None}, positiveAlpha={'d5': 0.353, 'd10': 0.545, 'd20': None}
- shadow:us_precision_v1: n=67/71, alpha={'d5': 0.92, 'd10': 0.98, 'd20': 1.35}, positiveAlpha={'d5': 0.526, 'd10': 0.569, 'd20': 0.548}

## Decision And Abstention Audit
- snapshots: 95
- abstentions: {'MISSED_OPPORTUNITY': 37, 'DEGRADED_DATA': 2, 'GOOD_ABSTENTION': 2, 'PENDING': 7}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 759
- avg D20 opportunity cost: 7.85
- avg D20 ex-post upper-bound gap: 29.76
