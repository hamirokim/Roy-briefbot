...
- MIXED: n=48, avgD20=-1.46, avgAlphaD20=0.98, winner=0.438, failed_fast=0.5, bought=0
- POSITIVE: n=18, avgD20=-13.37, avgAlphaD20=4.34, winner=0.0, failed_fast=1.0, bought=0
- NEGATIVE: n=10, avgD20=-23.34, avgAlphaD20=-6.06, winner=0.0, failed_fast=1.0, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.53, avgD10=4.32, avgD20=12.8, alphaD20=11.09
- pre_entry_v1: n=34/38, avgD5=-0.73, avgD10=-2.53, avgD20=None, alphaD20=None
- us_precision_v1: n=57/57, avgD5=1.65, avgD10=2.96, avgD20=5.01, alphaD20=2.31

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=82/184, target=52, stop=30, late=45, avgR=0.02
- confirmed_swings_v1: resolved=116/411, target=41, stop=75, late=31, avgR=-0.34
- prominence_reaction_v2: resolved=83/184, target=48, stop=35, late=47, avgR=0.01
- rolling_extrema_v1: resolved=26/184, target=5, stop=21, late=1, avgR=-0.71

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=255/261, alpha={'d5': 0.66, 'd10': 0.95, 'd20': 5.72}, positiveAlpha={'d5': 0.572, 'd10': 0.596, 'd20': 0.621}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.06, 'd10': 4.04, 'd20': 11.09}, positiveAlpha={'d5': 0.5, 'd10': 0.6, 'd20': 0.714}
- shadow:pre_entry_v1: n=34/38, alpha={'d5': -0.39, 'd10': -1.88, 'd20': None}, positiveAlpha={'d5': 0.409, 'd10': 0.5, 'd20': None}
- shadow:us_precision_v1: n=57/57, alpha={'d5': 1.07, 'd10': 1.58, 'd20': 2.31}, positiveAlpha={'d5': 0.549, 'd10': 0.604, 'd20': 0.586}

## Decision And Abstention Audit
- snapshots: 87
- abstentions: {'MISSED_OPPORTUNITY': 30, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 690
- avg D20 opportunity cost: 8.76
- avg D20 ex-post upper-bound gap: 29.21
