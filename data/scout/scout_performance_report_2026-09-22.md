...
- date: 2026-09-22
- evaluated candidates: 134 / 135
- actually bought: 0
- avg D20 return: -2.84
- avg alpha: {'d5': 0.31, 'd10': -0.01, 'd20': 1.6}
- positive alpha rate: {'d5': 0.545, 'd10': 0.552, 'd20': 0.567}
- verdicts: {'FAILED_FAST': 77, 'WINNER': 50, 'NEUTRAL': 7}
...
### by_lane
- strength: n=61, avgD20=-4.32, avgAlphaD20=-1.01, winner=0.361, failed_fast=0.557, bought=0
- pullback: n=41, avgD20=-5.39, avgAlphaD20=1.13, winner=0.268, failed_fast=0.732, bought=0
- left_side: n=32, avgD20=3.25, avgAlphaD20=7.17, winner=0.531, failed_fast=0.406, bought=0

### by_lane_status
- STRONG_PASS: n=78, avgD20=-3.86, avgAlphaD20=0.05, winner=0.346, failed_fast=0.59, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=2.19, avgAlphaD20=2.24, winner=0.75, failed_fast=0.167, bought=0
...
### by_theme_industry
- SUPPORT: n=65, avgD20=1.36, avgAlphaD20=1.14, winner=0.538, failed_fast=0.369, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=55, avgD20=2.59, avgAlphaD20=3.69, winner=0.473, failed_fast=0.455, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-0.48, avgAlphaD20=2.78, winner=0.475, failed_fast=0.458, bought=0
- POSITIVE_REVALUATION: n=38, avgD20=-3.66, avgAlphaD20=-2.83, winner=0.342, failed_fast=0.579, bought=0
...
### by_market_regime
- POSITIVE: n=58, avgD20=-3.16, avgAlphaD20=2.53, winner=0.31, failed_fast=0.638, bought=0
- NEGATIVE: n=55, avgD20=-5.48, avgAlphaD20=-0.02, winner=0.364, failed_fast=0.582, bought=0
- BULL: n=18, avgD20=5.9, avgAlphaD20=4.54, winner=0.611, failed_fast=0.333, bought=0
- MIXED: n=3, avgD20=-0.64, avgAlphaD20=-4.17, winner=0.333, failed_fast=0.667, bought=0

## LLM Override Comparison
- counts: dropped=7, added=19, kept=116
- avg D5: dropped=-1.26, added=-1.81, kept=-0.52
- avg D20: dropped=-9.89, added=-4.38, kept=-2.59
...
- NONE: n=130/131, alpha={'d5': 0.1, 'd10': -0.43, 'd20': 1.35}, positiveAlpha={'d5': 0.531, 'd10': 0.538, 'd20': 0.554}
- SUPPORT: n=4/4, alpha={'d5': 6.87, 'd10': 13.52, 'd20': 9.77}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}

## Precision Shadow Comparison
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.24, avgD20=4.11, alphaD20=4.33
- pre_entry_v1: n=60/66, avgD5=-1.11, avgD10=-2.14, avgD20=-2.85, alphaD20=-1.12
- us_precision_v1: n=77/83, avgD5=0.77, avgD10=2.12, avgD20=2.44, alphaD20=1.49

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=130/317, target=78, stop=52, late=91, avgR=-0.01
- confirmed_swings_v1: resolved=206/715, target=83, stop=123, late=59, avgR=-0.25
- prominence_reaction_v2: resolved=146/317, target=86, stop=60, late=91, avgR=-0.01
- rolling_extrema_v1: resolved=74/317, target=9, stop=65, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=296/303, alpha={'d5': 0.29, 'd10': 0.19, 'd20': 4.34}, positiveAlpha={'d5': 0.554, 'd10': 0.544, 'd20': 0.595}
- production:integrity_v1: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 11.26}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
- production:integrity_v1_unversioned: n=3/3, alpha={'d5': -2.24, 'd10': -3.0, 'd20': -4.17}, positiveAlpha={'d5': 0.333, 'd10': 0.333, 'd20': 0.333}
- production:legacy_recorded: n=125/126, alpha={'d5': 0.12, 'd10': -0.69, 'd20': 1.28}, positiveAlpha={'d5': 0.528, 'd10': 0.536, 'd20': 0.552}
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 11.26}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- production_lane:legacy_recorded:strength: n=58/59, alpha={'d5': 1.69, 'd10': 1.46, 'd20': -0.84}, positiveAlpha={'d5': 0.638, 'd10': 0.603, 'd20': 0.534}
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 11.26}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- production_lane_status:legacy_recorded:strength:STRONG_PASS: n=55/56, alpha={'d5': 2.2, 'd10': 1.7, 'd20': -0.44}, positiveAlpha={'d5': 0.655, 'd10': 0.618, 'd20': 0.545}
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.03, 'd20': 4.33}, positiveAlpha={'d5': 0.514, 'd10': 0.595, 'd20': 0.571}
- shadow:pre_entry_v1: n=60/66, alpha={'d5': -0.6, 'd10': -1.54, 'd20': -1.12}, positiveAlpha={'d5': 0.354, 'd10': 0.382, 'd20': 0.5}
- shadow:us_precision_v1: n=77/83, alpha={'d5': 0.47, 'd10': 1.01, 'd20': 1.49}, positiveAlpha={'d5': 0.493, 'd10': 0.561, 'd20': 0.562}

## Decision And Abstention Audit
- snapshots: 101
- abstentions: {'MISSED_OPPORTUNITY': 43, 'DEGRADED_DATA': 2, 'GOOD_ABSTENTION': 1, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 818
- avg D20 opportunity cost: 7.83
- avg D20 ex-post upper-bound gap: 28.46
...
- 2026-06-24 CPRX PENDING D20=None alphaD20=None MFE=None MAE=None bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-08-10 GFI WINNER D20=16.86 alphaD20=17.72 MFE=21.59 MAE=-2.9 bought=False lane=left_side catalyst=
- 2026-08-10 EQX WINNER D20=9.91 alphaD20=10.77 MFE=22.43 MAE=-3.65 bought=False lane=left_side catalyst=
- 2026-08-11 CDE WINNER D20=16.21 alphaD20=17.78 MFE=24.24 MAE=-0.66 bought=False lane=left_side catalyst=
- 2026-08-12 CMCSA WINNER D20=-1.45 alphaD20=0.73 MFE=7.09 MAE=-5.29 bought=False lane=left_side catalyst=
- 2026-08-12 RCI WINNER D20=2.56 alphaD20=4.74 MFE=8.24 MAE=-0.54 bought=False lane=left_side catalyst=
