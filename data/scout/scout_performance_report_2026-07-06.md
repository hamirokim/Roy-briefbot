...
- date: 2026-07-06
- evaluated candidates: 93 / 102
- actually bought: 0
- avg D20 return: -1.08
- verdicts: {'FAILED_FAST': 47, 'WINNER': 18, 'WATCH': 10, 'PENDING': 18}

## Aggregates

### by_lane
- strength: n=55, avgD20=-0.35, winner=0.236, failed_fast=0.455, bought=0
- pullback: n=27, avgD20=-7.62, winner=0.111, failed_fast=0.704, bought=0
- left_side: n=11, avgD20=1.15, winner=0.182, failed_fast=0.273, bought=0

### by_lane_status
- STRONG_PASS: n=68, avgD20=0.78, winner=0.235, failed_fast=0.515, bought=0
- PASS: n=13, avgD20=-33.1, winner=0.0, failed_fast=0.692, bought=0
- STAGE2_PASS: n=7, avgD20=1.15, winner=0.143, failed_fast=0.286, bought=0
...
### by_theme_industry
- SUPPORT: n=50, avgD20=2.41, winner=0.34, failed_fast=0.36, bought=0
- NO_MAPPING: n=28, avgD20=-10.53, winner=0.0, failed_fast=0.857, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=37, avgD20=-1.2, winner=0.297, failed_fast=0.378, bought=0
- QUALITY_SUPPORT: n=27, avgD20=2.98, winner=0.222, failed_fast=0.481, bought=0
- not_checked: n=16, avgD20=None, winner=0.062, failed_fast=0.625, bought=0
- NEUTRAL: n=11, avgD20=-10.53, winner=0.0, failed_fast=0.727, bought=0
- DATA_LIGHT: n=2, avgD20=None, winner=0.0, failed_fast=1.0, bought=0

### by_catalyst
- unknown: n=38, avgD20=0.68, winner=0.289, failed_fast=0.474, bought=0
- POSITIVE_REVALUATION: n=28, avgD20=-4.95, winner=0.179, failed_fast=0.5, bought=0
- NOISE: n=22, avgD20=5.45, winner=0.091, failed_fast=0.5, bought=0
- NO_DATA: n=5, avgD20=None, winner=0.0, failed_fast=0.8, bought=0

## LLM Override Comparison
- counts: dropped=7, added=17, kept=85
- avg D5: dropped=-2.51, added=-1.43, kept=-1.21
- avg D20: dropped=-3.67, added=-1.72, kept=-0.95
...
- 2026-06-18 REGN WATCH D5=3.76 D20=None MFE=7.38 MAE=-2.47 lane=left_side:STAGE2_PASS
...
- 2026-06-27 003230.KS PENDING D5=None D20=None MFE=5.6 MAE=-5.43 lane=left_side:STAGE2_PASS
- 2026-07-02 IBM PENDING D5=None D20=None MFE=0.49 MAE=-2.5 lane=pullback:WAIT
...
- 2026-06-04 NVT FAILED_FAST D20=None MFE=6.19 MAE=-13.83 bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-06-05 IRM FAILED_FAST D20=None MFE=8.04 MAE=-7.2 bought=False lane=strength catalyst=NOISE
...
- 2026-06-06 DINO FAILED_FAST D20=None MFE=2.87 MAE=-11.84 bought=False lane=strength catalyst=NOISE
...
- 2026-06-18 REGN WATCH D20=None MFE=7.38 MAE=-2.47 bought=False lane=left_side catalyst=NOISE
...
- 2026-06-22 440110.KQ FAILED_FAST D20=None MFE=2.5 MAE=-38.22 bought=False lane=pullback catalyst=
...
- 2026-06-26 HEI PENDING D20=None MFE=6.19 MAE=-2.61 bought=False lane=strength catalyst=
- 2026-06-26 PANW PENDING D20=None MFE=17.72 MAE=-4.67 bought=False lane=strength catalyst=NOISE
- 2026-06-26 ROKU PENDING D20=None MFE=5.37 MAE=-0.77 bought=False lane=strength catalyst=
- 2026-06-27 NU PENDING D20=None MFE=6.09 MAE=-1.45 bought=False lane=left_side catalyst=
- 2026-06-27 APD PENDING D20=None MFE=15.82 MAE=-0.46 bought=False lane=pullback catalyst=POSITIVE_REVALUATION
- 2026-06-27 003230.KS PENDING D20=None MFE=5.6 MAE=-5.43 bought=False lane=left_side catalyst=NO_DATA
...
- 2026-06-30 CRWD PENDING D20=None MFE=4.58 MAE=-4.08 bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-07-01 TIGO PENDING D20=None MFE=5.4 MAE=-2.75 bought=False lane=strength catalyst=
...
- 2026-07-02 IBM PENDING D20=None MFE=0.49 MAE=-2.5 bought=False lane=pullback catalyst=NOISE
- 2026-07-02 098460.KQ PENDING D20=None MFE=10.29 MAE=-8.43 bought=False lane=pullback catalyst=
- 2026-07-03 DDOG PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=
- 2026-07-03 OKTA PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=
- 2026-07-03 PANW PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-07-04 001800.KS PENDING D20=None MFE=None MAE=None bought=False lane=pullback catalyst=
- 2026-07-04 A PENDING D20=None MFE=None MAE=None bought=False lane=left_side catalyst=POSITIVE_REVALUATION
- 2026-07-04 069960.KS PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=NOISE
- 2026-07-06 003230.KS PENDING D20=None MFE=None MAE=None bought=False lane=left_side catalyst=NOISE
- 2026-07-06 PUK PENDING D20=None MFE=None MAE=None bought=False lane=left_side catalyst=NOISE
- 2026-07-06 029780.KS PENDING D20=None MFE=None MAE=None bought=False lane=left_side catalyst=NOISE
