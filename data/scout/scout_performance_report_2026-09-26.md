...
### by_market_regime
- BULL: n=58, avgD20=2.82, avgAlphaD20=2.59, winner=0.5, failed_fast=0.431, bought=0
- MIXED: n=39, avgD20=-1.27, avgAlphaD20=-2.14, winner=0.513, failed_fast=0.41, bought=0
- NEGATIVE: n=19, avgD20=-13.37, avgAlphaD20=3.67, winner=0.053, failed_fast=0.947, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.24, avgD20=4.52, alphaD20=4.73
- pre_entry_v1: n=70/74, avgD5=-1.22, avgD10=-2.24, avgD20=-4.52, alphaD20=-4.02
- us_precision_v1: n=86/86, avgD5=0.8, avgD10=1.17, avgD20=1.63, alphaD20=0.67

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=149/367, target=89, stop=60, late=111, avgR=-0.03
- confirmed_swings_v1: resolved=232/824, target=98, stop=134, late=73, avgR=-0.15
- prominence_reaction_v2: resolved=168/367, target=96, stop=72, late=115, avgR=-0.03
- rolling_extrema_v1: resolved=89/367, target=9, stop=80, late=1, avgR=-0.85

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=306/315, alpha={'d5': 0.14, 'd10': 0.13, 'd20': 3.86}, positiveAlpha={'d5': 0.535, 'd10': 0.544, 'd20': 0.579}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.03, 'd20': 4.73}, positiveAlpha={'d5': 0.514, 'd10': 0.595, 'd20': 0.583}
- shadow:pre_entry_v1: n=70/74, alpha={'d5': -1.04, 'd10': -1.95, 'd20': -4.02}, positiveAlpha={'d5': 0.362, 'd10': 0.348, 'd20': 0.25}
- shadow:us_precision_v1: n=86/86, alpha={'d5': 0.38, 'd10': 0.11, 'd20': 0.67}, positiveAlpha={'d5': 0.486, 'd10': 0.485, 'd20': 0.529}

## Decision And Abstention Audit
- snapshots: 105
- abstentions: {'MISSED_OPPORTUNITY': 48, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 840
- avg D20 opportunity cost: 7.41
- avg D20 ex-post upper-bound gap: 27.93
