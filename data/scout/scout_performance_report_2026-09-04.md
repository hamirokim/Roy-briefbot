...
- left_side_context_v1: n=37/37, avgD5=2.53, avgD10=4.32, avgD20=13.24, alphaD20=11.31
- pre_entry_v1: n=32/36, avgD5=-0.68, avgD10=-3.44, avgD20=None, alphaD20=None
...
- winner declared: False
- atr_reversal_v1: resolved=77/170, target=47, stop=30, late=37, avgR=-0.05
- confirmed_swings_v1: resolved=108/389, target=34, stop=74, late=29, avgR=-0.49
- prominence_reaction_v2: resolved=77/170, target=42, stop=35, late=43, avgR=-0.04
- rolling_extrema_v1: resolved=24/170, target=3, stop=21, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=252/258, alpha={'d5': 0.69, 'd10': 1.01, 'd20': 5.79}, positiveAlpha={'d5': 0.575, 'd10': 0.6, 'd20': 0.626}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.06, 'd10': 4.04, 'd20': 11.31}, positiveAlpha={'d5': 0.5, 'd10': 0.6, 'd20': 0.75}
- shadow:pre_entry_v1: n=32/36, alpha={'d5': -0.25, 'd10': -2.39, 'd20': None}, positiveAlpha={'d5': 0.4, 'd10': 0.5, 'd20': None}
...
- snapshots: 86
- abstentions: {'MISSED_OPPORTUNITY': 29, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 676
- avg D20 opportunity cost: 8.68
...
- 2026-08-12 RCI WINNER D20=None alphaD20=None MFE=6.25 MAE=-0.54 bought=False lane=left_side catalyst=
