...
- NEGATIVE: n=46, avgD20=-6.71, avgAlphaD20=0.14, winner=0.348, failed_fast=0.587, bought=0
- BULL: n=23, avgD20=5.71, avgAlphaD20=4.04, winner=0.609, failed_fast=0.304, bought=0
- MIXED: n=12, avgD20=0.42, avgAlphaD20=-1.69, winner=0.417, failed_fast=0.583, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.24, avgD20=5.96, alphaD20=5.77
- pre_entry_v1: n=52/56, avgD5=-1.04, avgD10=-1.7, avgD20=-7.85, alphaD20=-5.58
- us_precision_v1: n=68/74, avgD5=1.39, avgD10=2.27, avgD20=2.64, alphaD20=1.31

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=113/267, target=72, stop=41, late=78, avgR=0.07
- confirmed_swings_v1: resolved=177/616, target=76, stop=101, late=50, avgR=-0.21
- prominence_reaction_v2: resolved=132/267, target=81, stop=51, late=76, avgR=0.03
- rolling_extrema_v1: resolved=61/267, target=9, stop=52, late=1, avgR=-0.78

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=282/288, alpha={'d5': 0.36, 'd10': 0.67, 'd20': 4.83}, positiveAlpha={'d5': 0.552, 'd10': 0.573, 'd20': 0.601}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.03, 'd20': 5.77}, positiveAlpha={'d5': 0.514, 'd10': 0.595, 'd20': 0.607}
- shadow:pre_entry_v1: n=52/56, alpha={'d5': -0.67, 'd10': -1.22, 'd20': -5.58}, positiveAlpha={'d5': 0.333, 'd10': 0.5, 'd20': 0.5}
- shadow:us_precision_v1: n=68/74, alpha={'d5': 0.92, 'd10': 1.01, 'd20': 1.31}, positiveAlpha={'d5': 0.526, 'd10': 0.577, 'd20': 0.535}

## Decision And Abstention Audit
- snapshots: 96
- abstentions: {'MISSED_OPPORTUNITY': 38, 'DEGRADED_DATA': 2, 'GOOD_ABSTENTION': 1, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 770
- avg D20 opportunity cost: 7.85
- avg D20 ex-post upper-bound gap: 29.95
