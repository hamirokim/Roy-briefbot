...
- pre_entry_v1: n=68/72, avgD5=-1.19, avgD10=-2.47, avgD20=-4.95, alphaD20=-4.27
- us_precision_v1: n=86/86, avgD5=0.92, avgD10=1.63, avgD20=1.67, alphaD20=0.71

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=145/362, target=89, stop=56, late=109, avgR=-0.01
- confirmed_swings_v1: resolved=226/805, target=100, stop=126, late=70, avgR=-0.12
- prominence_reaction_v2: resolved=160/362, target=97, stop=63, late=109, avgR=0.02
- rolling_extrema_v1: resolved=83/362, target=9, stop=74, late=1, avgR=-0.84

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=306/312, alpha={'d5': 0.2, 'd10': 0.17, 'd20': 4.04}, positiveAlpha={'d5': 0.542, 'd10': 0.549, 'd20': 0.583}
...
- shadow:pre_entry_v1: n=68/72, alpha={'d5': -0.94, 'd10': -2.07, 'd20': -4.27}, positiveAlpha={'d5': 0.352, 'd10': 0.333, 'd20': 0.312}
- shadow:us_precision_v1: n=86/86, alpha={'d5': 0.52, 'd10': 0.55, 'd20': 0.71}, positiveAlpha={'d5': 0.5, 'd10': 0.533, 'd20': 0.529}

## Decision And Abstention Audit
- snapshots: 104
- abstentions: {'MISSED_OPPORTUNITY': 46, 'DEGRADED_DATA': 2, 'PENDING': 9}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 830
- avg D20 opportunity cost: 7.5
- avg D20 ex-post upper-bound gap: 28.23
