...
- date: 2026-08-12
- evaluated candidates: 133 / 135
- actually bought: 0
- avg D20 return: -3.54
- avg alpha: {'d5': 0.18, 'd10': -0.69, 'd20': 1.22}
- positive alpha rate: {'d5': 0.527, 'd10': 0.536, 'd20': 0.562}
- verdicts: {'FAILED_FAST': 77, 'WINNER': 45, 'NEUTRAL': 7, 'PENDING': 4}
...
- pullback: n=41, avgD20=-5.63, avgAlphaD20=1.54, winner=0.268, failed_fast=0.732, bought=0
- left_side: n=30, avgD20=1.68, avgAlphaD20=5.53, winner=0.4, failed_fast=0.433, bought=0

### by_lane_status
- STRONG_PASS: n=79, avgD20=-3.98, avgAlphaD20=0.22, winner=0.342, failed_fast=0.582, bought=0
- PASS: n=23, avgD20=-7.79, avgAlphaD20=0.72, winner=0.261, failed_fast=0.739, bought=0
- STAGE2_PASS: n=19, avgD20=3.7, avgAlphaD20=8.61, winner=0.421, failed_fast=0.526, bought=0
- STAGE2_STRONG_PASS: n=10, avgD20=-5.62, avgAlphaD20=-6.77, winner=0.4, failed_fast=0.2, bought=0
...
### by_theme_industry
- SUPPORT: n=64, avgD20=1.12, avgAlphaD20=0.9, winner=0.469, failed_fast=0.375, bought=0
- NO_MAPPING: n=37, avgD20=-13.62, avgAlphaD20=3.68, winner=0.027, failed_fast=0.973, bought=0
- STRONG_SUPPORT: n=20, avgD20=-1.16, avgAlphaD20=-1.28, winner=0.4, failed_fast=0.6, bought=0
- SECTOR_UNSUPPORTED: n=10, avgD20=1.05, avgAlphaD20=-1.24, winner=0.5, failed_fast=0.5, bought=0
- SECTOR_NEUTRAL: n=2, avgD20=3.01, avgAlphaD20=1.11, winner=0.5, failed_fast=0.0, bought=0

### by_quality_auditor
- STRONG_QUALITY: n=54, avgD20=2.38, avgAlphaD20=3.7, winner=0.389, failed_fast=0.463, bought=0
- QUALITY_SUPPORT: n=38, avgD20=-7.07, avgAlphaD20=-1.61, winner=0.342, failed_fast=0.658, bought=0
...
### by_catalyst
- unknown: n=57, avgD20=-1.88, avgAlphaD20=1.94, winner=0.404, failed_fast=0.474, bought=0
- POSITIVE_REVALUATION: n=39, avgD20=-3.55, avgAlphaD20=-2.38, winner=0.333, failed_fast=0.564, bought=0
- NOISE: n=32, avgD20=-5.18, avgAlphaD20=2.28, winner=0.281, failed_fast=0.719, bought=0
- NO_DATA: n=5, avgD20=-9.49, avgAlphaD20=12.75, winner=0.0, failed_fast=1.0, bought=0

### by_market_regime
- BULL: n=70, avgD20=-1.45, avgAlphaD20=2.87, winner=0.329, failed_fast=0.557, bought=0
- MIXED: n=53, avgD20=-3.66, avgAlphaD20=-0.17, winner=0.396, failed_fast=0.547, bought=0
- POSITIVE: n=5, avgD20=-8.68, avgAlphaD20=-2.46, winner=0.2, failed_fast=0.8, bought=0
...
- avg D5: dropped=-1.26, added=-1.81, kept=-0.69
- avg D20: dropped=-9.89, added=-4.38, kept=-3.39
...
- NONE: n=131/131, alpha={'d5': 0.06, 'd10': -0.69, 'd20': 1.22}, positiveAlpha={'d5': 0.523, 'd10': 0.536, 'd20': 0.562}
- SUPPORT: n=2/4, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}

## Precision Shadow Comparison
- left_side_context_v1: n=22/24, avgD5=9.68, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=36/39, avgD5=3.91, avgD10=10.85, avgD20=None, alphaD20=None

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=195/198, alpha={'d5': 0.89, 'd10': 1.25, 'd20': 5.48}, positiveAlpha={'d5': 0.591, 'd10': 0.615, 'd20': 0.61}
- production:integrity_v1: n=4/6, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}
- production:integrity_v1_unversioned: n=3/3, alpha={'d5': -2.24, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.333, 'd10': None, 'd20': None}
- production:legacy_recorded: n=126/126, alpha={'d5': 0.12, 'd10': -0.69, 'd20': 1.22}, positiveAlpha={'d5': 0.528, 'd10': 0.536, 'd20': 0.562}
- production_lane:integrity_v1:left_side: n=4/6, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}
...
- production_lane:legacy_recorded:left_side: n=26/26, alpha={'d5': 1.18, 'd10': 2.92, 'd20': 5.53}, positiveAlpha={'d5': 0.615, 'd10': 0.731, 'd20': 0.68}
- production_lane:legacy_recorded:pullback: n=41/41, alpha={'d5': -2.76, 'd10': -6.02, 'd20': 1.54}, positiveAlpha={'d5': 0.317, 'd10': 0.317, 'd20': 0.526}
...
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=4/6, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}
...
- production_lane_status:legacy_recorded:left_side:STAGE2_PASS: n=19/19, alpha={'d5': 2.19, 'd10': 4.57, 'd20': 8.61}, positiveAlpha={'d5': 0.632, 'd10': 0.737, 'd20': 0.778}
...
- shadow:left_side_context_v1: n=22/24, alpha={'d5': 6.51, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.6, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=36/39, alpha={'d5': 2.29, 'd10': 8.07, 'd20': None}, positiveAlpha={'d5': 0.586, 'd10': 0.857, 'd20': None}

## Decision And Abstention Audit
- snapshots: 66
- abstentions: {'MISSED_OPPORTUNITY': 15, 'PENDING': 4}
- D20 selected nonpositive alpha: 53
- D20 rejected positive alpha: 424
- avg D20 opportunity cost: 9.23
- avg D20 ex-post upper-bound gap: 24.39
...
- 2026-07-13 204320.KS FAILED_FAST D20=9.4 alphaD20=None MFE=12.03 MAE=-23.96 bought=False lane=left_side catalyst=NOISE
...
- 2026-08-04 ZS WINNER D20=None alphaD20=None MFE=17.55 MAE=-0.04 bought=False lane=left_side catalyst=
- 2026-08-10 GFI PENDING D20=None alphaD20=None MFE=2.15 MAE=-1.62 bought=False lane=left_side catalyst=
- 2026-08-10 EQX PENDING D20=None alphaD20=None MFE=2.91 MAE=-2.78 bought=False lane=left_side catalyst=
- 2026-08-11 CDE PENDING D20=None alphaD20=None MFE=2.96 MAE=-0.66 bought=False lane=left_side catalyst=
- 2026-08-12 CMCSA PENDING D20=None alphaD20=None MFE=None MAE=None bought=False lane=left_side catalyst=
- 2026-08-12 RCI PENDING D20=None alphaD20=None MFE=None MAE=None bought=False lane=left_side catalyst=
