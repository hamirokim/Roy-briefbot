...
### by_market_regime
- POSITIVE: n=55, avgD20=-3.71, avgAlphaD20=2.45, winner=0.273, failed_fast=0.673, bought=0
- NEGATIVE: n=55, avgD20=-5.48, avgAlphaD20=-0.02, winner=0.364, failed_fast=0.582, bought=0
- BULL: n=21, avgD20=6.04, avgAlphaD20=4.47, winner=0.667, failed_fast=0.286, bought=0
...
- pre_entry_v1: n=60/64, avgD5=-1.11, avgD10=-2.14, avgD20=-2.85, alphaD20=-1.12
- us_precision_v1: n=77/80, avgD5=0.77, avgD10=2.12, avgD20=2.44, alphaD20=1.49

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=128/311, target=77, stop=51, late=89, avgR=-0.0
- confirmed_swings_v1: resolved=198/709, target=82, stop=116, late=58, avgR=-0.24
- prominence_reaction_v2: resolved=144/311, target=84, stop=60, late=89, avgR=-0.02
- rolling_extrema_v1: resolved=74/311, target=9, stop=65, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=294/300, alpha={'d5': 0.34, 'd10': 0.45, 'd20': 4.31}, positiveAlpha={'d5': 0.558, 'd10': 0.555, 'd20': 0.594}
...
- shadow:pre_entry_v1: n=60/64, alpha={'d5': -0.6, 'd10': -1.54, 'd20': -1.12}, positiveAlpha={'d5': 0.354, 'd10': 0.382, 'd20': 0.5}
- shadow:us_precision_v1: n=77/80, alpha={'d5': 0.47, 'd10': 1.01, 'd20': 1.49}, positiveAlpha={'d5': 0.493, 'd10': 0.561, 'd20': 0.562}

## Decision And Abstention Audit
- snapshots: 100
- abstentions: {'MISSED_OPPORTUNITY': 43, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 817
- avg D20 opportunity cost: 7.81
- avg D20 ex-post upper-bound gap: 28.71
