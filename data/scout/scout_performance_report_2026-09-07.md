...
### by_market_regime
- BULL: n=77, avgD20=-1.71, avgAlphaD20=2.49, winner=0.364, failed_fast=0.558, bought=0
- MIXED: n=53, avgD20=-3.5, avgAlphaD20=-0.03, winner=0.396, failed_fast=0.547, bought=0
...
- pre_entry_v1: n=36/40, avgD5=-0.74, avgD10=-2.07, avgD20=None, alphaD20=None
- us_precision_v1: n=57/57, avgD5=1.56, avgD10=2.96, avgD20=5.01, alphaD20=2.31

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=84/188, target=54, stop=30, late=47, avgR=0.03
- confirmed_swings_v1: resolved=117/426, target=42, stop=75, late=34, avgR=-0.34
- prominence_reaction_v2: resolved=84/188, target=49, stop=35, late=49, avgR=0.01
- rolling_extrema_v1: resolved=32/188, target=5, stop=27, late=1, avgR=-0.76

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=257/264, alpha={'d5': 0.66, 'd10': 0.97, 'd20': 5.75}, positiveAlpha={'d5': 0.572, 'd10': 0.602, 'd20': 0.625}
...
- shadow:pre_entry_v1: n=36/40, alpha={'d5': -0.41, 'd10': -1.62, 'd20': None}, positiveAlpha={'d5': 0.417, 'd10': 0.5, 'd20': None}
- shadow:us_precision_v1: n=57/57, alpha={'d5': 1.0, 'd10': 1.58, 'd20': 2.31}, positiveAlpha={'d5': 0.538, 'd10': 0.604, 'd20': 0.586}

## Decision And Abstention Audit
- snapshots: 88
- abstentions: {'MISSED_OPPORTUNITY': 31, 'DEGRADED_DATA': 2, 'PENDING': 8}
