...
- MIXED: n=40, avgD20=-1.35, avgAlphaD20=-2.2, winner=0.5, failed_fast=0.425, bought=0
- POSITIVE: n=18, avgD20=-13.37, avgAlphaD20=4.34, winner=0.0, failed_fast=1.0, bought=0
- NEGATIVE: n=18, avgD20=-13.87, avgAlphaD20=4.13, winner=0.056, failed_fast=0.944, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.24, avgD20=4.32, alphaD20=4.38
- pre_entry_v1: n=54/58, avgD5=-1.16, avgD10=-1.97, avgD20=-6.69, alphaD20=-4.32
- us_precision_v1: n=71/74, avgD5=1.07, avgD10=2.08, avgD20=2.49, alphaD20=1.47

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=120/280, target=75, stop=45, late=78, avgR=0.05
- confirmed_swings_v1: resolved=189/641, target=79, stop=110, late=50, avgR=-0.23
- prominence_reaction_v2: resolved=140/280, target=83, stop=57, late=77, avgR=-0.01
- rolling_extrema_v1: resolved=69/280, target=9, stop=60, late=1, avgR=-0.81

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=285/291, alpha={'d5': 0.35, 'd10': 0.59, 'd20': 4.49}, positiveAlpha={'d5': 0.556, 'd10': 0.563, 'd20': 0.593}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.03, 'd20': 4.38}, positiveAlpha={'d5': 0.514, 'd10': 0.595, 'd20': 0.581}
- shadow:pre_entry_v1: n=54/58, alpha={'d5': -0.63, 'd10': -1.37, 'd20': -4.32}, positiveAlpha={'d5': 0.357, 'd10': 0.464, 'd20': 0.333}
- shadow:us_precision_v1: n=71/74, alpha={'d5': 0.69, 'd10': 0.91, 'd20': 1.47}, positiveAlpha={'d5': 0.5, 'd10': 0.556, 'd20': 0.553}

## Decision And Abstention Audit
- snapshots: 97
- abstentions: {'MISSED_OPPORTUNITY': 40, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 794
- avg D20 opportunity cost: 7.58
- avg D20 ex-post upper-bound gap: 29.19
