...
- left_side_context_v1: n=36/37, avgD5=2.6, avgD10=8.07, avgD20=3.79, alphaD20=-0.96
- pre_entry_v1: n=22/24, avgD5=-0.38, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=51/52, avgD5=2.1, avgD10=3.42, avgD20=7.38, alphaD20=4.2

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=41/91, target=25, stop=16, late=22, avgR=-0.04
- confirmed_swings_v1: resolved=66/274, target=21, stop=45, late=18, avgR=-0.46
- prominence_reaction_v2: resolved=46/91, target=28, stop=18, late=19, avgR=0.16
- rolling_extrema_v1: resolved=3/91, target=2, stop=1, late=1, avgR=0.13

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=237/240, alpha={'d5': 0.67, 'd10': 1.3, 'd20': 5.51}, positiveAlpha={'d5': 0.575, 'd10': 0.61, 'd20': 0.622}
...
- shadow:left_side_context_v1: n=36/37, alpha={'d5': 2.09, 'd10': 7.35, 'd20': -0.96}, positiveAlpha={'d5': 0.486, 'd10': 0.692, 'd20': 0.5}
- shadow:pre_entry_v1: n=22/24, alpha={'d5': 0.58, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.6, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=51/52, alpha={'d5': 1.5, 'd10': 1.67, 'd20': 4.2}, positiveAlpha={'d5': 0.583, 'd10': 0.595, 'd20': 0.588}

## Decision And Abstention Audit
- snapshots: 80
- abstentions: {'MISSED_OPPORTUNITY': 26, 'DEGRADED_DATA': 2, 'PENDING': 5}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 616
- avg D20 opportunity cost: 8.55
- avg D20 ex-post upper-bound gap: 26.36
...
- 2026-08-11 CDE WINNER D20=None alphaD20=None MFE=23.02 MAE=-0.66 bought=False lane=left_side catalyst=
- 2026-08-12 CMCSA WINNER D20=None alphaD20=None MFE=7.09 MAE=-1.84 bought=False lane=left_side catalyst=
- 2026-08-12 RCI WATCH D20=None alphaD20=None MFE=5.66 MAE=-0.54 bought=False lane=left_side catalyst=
