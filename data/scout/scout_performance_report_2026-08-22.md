...
- actually bought: 0
- avg D20 return: -3.51
- avg alpha: {'d5': 0.31, 'd10': -0.58, 'd20': 1.28}
- positive alpha rate: {'d5': 0.545, 'd10': 0.535, 'd20': 0.552}
...
- POSITIVE: n=44, avgD20=-3.3, avgAlphaD20=1.61, winner=0.273, failed_fast=0.659, bought=0
- BULL: n=33, avgD20=0.31, avgAlphaD20=3.46, winner=0.455, failed_fast=0.424, bought=0
- BEAR: n=5, avgD20=-23.62, avgAlphaD20=-2.41, winner=0.0, failed_fast=1.0, bought=0
- NEGATIVE: n=4, avgD20=-13.59, avgAlphaD20=-5.64, winner=0.0, failed_fast=1.0, bought=0
...
- left_side_context_v1: n=35/35, avgD5=4.76, avgD10=11.67, avgD20=None, alphaD20=None
- pre_entry_v1: n=12/14, avgD5=-1.7, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=48/51, avgD5=2.32, avgD10=4.74, avgD20=7.98, alphaD20=4.65

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=13/40, target=10, stop=3, late=12, avgR=0.08
- confirmed_swings_v1: resolved=37/163, target=10, stop=27, late=9, avgR=-0.68
- prominence_reaction_v2: resolved=17/40, target=9, stop=8, late=11, avgR=-0.11
- rolling_extrema_v1: resolved=1/40, target=0, stop=1, late=0, avgR=-1.0

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=222/225, alpha={'d5': 0.78, 'd10': 1.57, 'd20': 6.27}, positiveAlpha={'d5': 0.581, 'd10': 0.62, 'd20': 0.642}
...
- shadow:left_side_context_v1: n=35/35, alpha={'d5': 3.88, 'd10': 9.86, 'd20': None}, positiveAlpha={'d5': 0.536, 'd10': 0.688, 'd20': None}
- shadow:pre_entry_v1: n=12/14, alpha={'d5': -0.05, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.5, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=48/51, alpha={'d5': 1.49, 'd10': 1.77, 'd20': 4.65}, positiveAlpha={'d5': 0.558, 'd10': 0.586, 'd20': 0.7}

## Decision And Abstention Audit
- snapshots: 75
- abstentions: {'MISSED_OPPORTUNITY': 20, 'DEGRADED_DATA': 2, 'PENDING': 6}
- D20 selected nonpositive alpha: 56
- D20 rejected positive alpha: 569
- avg D20 opportunity cost: 8.29
...
- 2026-08-10 EQX WINNER D20=None alphaD20=None MFE=17.87 MAE=-3.65 bought=False lane=left_side catalyst=
