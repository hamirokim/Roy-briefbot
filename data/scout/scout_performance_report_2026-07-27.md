...
- date: 2026-07-27
- evaluated candidates: 87 / 87
- actually bought: 0
- avg D20 return: -8.15
- verdicts: {'FAILED_FAST': 49, 'WINNER': 23, 'PENDING': 1, 'NEUTRAL': 1, 'WATCH': 13}

## Aggregates

### by_lane
- strength: n=32, avgD20=-8.04, winner=0.344, failed_fast=0.594, bought=0
- pullback: n=32, avgD20=-11.21, winner=0.156, failed_fast=0.688, bought=0
- left_side: n=23, avgD20=-1.3, winner=0.304, failed_fast=0.348, bought=0

### by_lane_status
- STRONG_PASS: n=42, avgD20=-8.61, winner=0.286, failed_fast=0.619, bought=0
...
### by_theme_industry
- SUPPORT: n=31, avgD20=1.9, winner=0.419, failed_fast=0.387, bought=0
- NO_MAPPING: n=30, avgD20=-18.27, winner=0.067, failed_fast=0.867, bought=0
...
- QUALITY_SUPPORT: n=24, avgD20=-12.92, winner=0.25, failed_fast=0.667, bought=0
- not_checked: n=19, avgD20=-4.73, winner=0.263, failed_fast=0.474, bought=0
...
### by_catalyst
- unknown: n=34, avgD20=-8.99, winner=0.235, failed_fast=0.559, bought=0
- POSITIVE_REVALUATION: n=24, avgD20=1.61, winner=0.375, failed_fast=0.417, bought=0
...
- counts: dropped=4, added=14, kept=73
- avg D5: dropped=1.61, added=-3.74, kept=-2.54
- avg D20: dropped=-11.3, added=-3.11, kept=-10.17
...
- us_precision_v1: n=10/14, avgD5=-2.84, avgD10=None, avgD20=None
...
- 2026-06-25 TRGP FAILED_FAST D20=2.88 MFE=6.43 MAE=-6.37 bought=False lane=strength catalyst=
...
- 2026-07-11 AMZN WATCH D20=None MFE=4.35 MAE=-6.46 bought=False lane=pullback catalyst=NOISE
