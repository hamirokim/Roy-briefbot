...
- pre_entry_v1: n=64/70, avgD5=-1.28, avgD10=-2.13, avgD20=-4.27, alphaD20=-2.98
...
- winner declared: False
- atr_reversal_v1: resolved=135/339, target=81, stop=54, late=101, avgR=-0.01
- confirmed_swings_v1: resolved=215/762, target=89, stop=126, late=67, avgR=-0.16
- prominence_reaction_v2: resolved=154/339, target=91, stop=63, late=103, avgR=0.01
- rolling_extrema_v1: resolved=81/339, target=9, stop=72, late=1, avgR=-0.84

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=301/309, alpha={'d5': 0.28, 'd10': 0.2, 'd20': 4.35}, positiveAlpha={'d5': 0.55, 'd10': 0.544, 'd20': 0.599}
...
- shadow:pre_entry_v1: n=64/70, alpha={'d5': -0.95, 'd10': -1.6, 'd20': -2.98}, positiveAlpha={'d5': 0.346, 'd10': 0.378, 'd20': 0.417}
...
- snapshots: 103
- abstentions: {'MISSED_OPPORTUNITY': 45, 'DEGRADED_DATA': 2, 'PENDING': 9}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 824
- avg D20 opportunity cost: 7.86
- avg D20 ex-post upper-bound gap: 28.4
