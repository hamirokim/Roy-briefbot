...
- actually bought: 0
- avg D20 return: -3.53
- avg alpha: {'d5': 0.12, 'd10': -0.7, 'd20': 1.26}
- positive alpha rate: {'d5': 0.519, 'd10': 0.528, 'd20': 0.554}
- verdicts: {'FAILED_FAST': 78, 'WINNER': 45, 'NEUTRAL': 6, 'PENDING': 6}
...
### by_lane
- strength: n=62, avgD20=-4.51, avgAlphaD20=-1.21, winner=0.355, failed_fast=0.565, bought=0
- pullback: n=41, avgD20=-5.34, avgAlphaD20=1.6, winner=0.268, failed_fast=0.732, bought=0
- left_side: n=32, avgD20=1.53, avgAlphaD20=6.37, winner=0.375, failed_fast=0.406, bought=0

### by_lane_status
- STRONG_PASS: n=79, avgD20=-3.93, avgAlphaD20=0.08, winner=0.342, failed_fast=0.595, bought=0
- PASS: n=23, avgD20=-7.15, avgAlphaD20=0.37, winner=0.261, failed_fast=0.739, bought=0
- STAGE2_PASS: n=19, avgD20=3.59, avgAlphaD20=9.77, winner=0.421, failed_fast=0.526, bought=0
- STAGE2_STRONG_PASS: n=12, avgD20=-5.62, avgAlphaD20=-6.77, winner=0.333, failed_fast=0.167, bought=0
...
### by_theme_industry
- SUPPORT: n=66, avgD20=0.69, avgAlphaD20=0.47, winner=0.455, failed_fast=0.379, bought=0
- NO_MAPPING: n=37, avgD20=-13.29, avgAlphaD20=4.37, winner=0.027, failed_fast=0.973, bought=0
- STRONG_SUPPORT: n=20, avgD20=-1.08, avgAlphaD20=-1.21, winner=0.4, failed_fast=0.6, bought=0
- SECTOR_UNSUPPORTED: n=10, avgD20=1.39, avgAlphaD20=-0.87, winner=0.5, failed_fast=0.5, bought=0
- SECTOR_NEUTRAL: n=2, avgD20=3.01, avgAlphaD20=1.11, winner=0.5, failed_fast=0.0, bought=0

### by_quality_auditor
- STRONG_QUALITY: n=56, avgD20=2.32, avgAlphaD20=3.48, winner=0.375, failed_fast=0.446, bought=0
- QUALITY_SUPPORT: n=38, avgD20=-7.17, avgAlphaD20=-0.99, winner=0.342, failed_fast=0.658, bought=0
- not_checked: n=25, avgD20=-1.22, avgAlphaD20=1.14, winner=0.4, failed_fast=0.52, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-2.03, avgAlphaD20=1.5, winner=0.39, failed_fast=0.475, bought=0
- POSITIVE_REVALUATION: n=39, avgD20=-3.24, avgAlphaD20=-2.16, winner=0.333, failed_fast=0.564, bought=0
...
### by_market_regime
- BULL: n=66, avgD20=-0.86, avgAlphaD20=3.09, winner=0.333, failed_fast=0.53, bought=0
- MIXED: n=54, avgD20=-3.94, avgAlphaD20=0.03, winner=0.389, failed_fast=0.574, bought=0
- POSITIVE: n=10, avgD20=-6.67, avgAlphaD20=-1.32, winner=0.2, failed_fast=0.7, bought=0
...
- avg D5: dropped=-1.26, added=-1.81, kept=-0.87
- avg D20: dropped=-9.89, added=-4.24, kept=-3.41
...
- NONE: n=131/131, alpha={'d5': 0.01, 'd10': -0.7, 'd20': 1.26}, positiveAlpha={'d5': 0.516, 'd10': 0.528, 'd20': 0.554}
- SUPPORT: n=4/4, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}

## Precision Shadow Comparison
- left_side_context_v1: n=24/26, avgD5=10.01, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=39/42, avgD5=4.05, avgD10=10.37, avgD20=None, alphaD20=None

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=198/201, alpha={'d5': 0.94, 'd10': 1.35, 'd20': 5.56}, positiveAlpha={'d5': 0.615, 'd10': 0.613, 'd20': 0.603}
- production:integrity_v1: n=6/6, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}
- production:integrity_v1_unversioned: n=3/3, alpha={'d5': -4.1, 'd10': 0.71, 'd20': None}, positiveAlpha={'d5': 0.333, 'd10': 0.5, 'd20': None}
- production:legacy_recorded: n=126/126, alpha={'d5': 0.11, 'd10': -0.72, 'd20': 1.26}, positiveAlpha={'d5': 0.52, 'd10': 0.528, 'd20': 0.554}
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}
- production_lane:integrity_v1_unversioned:strength: n=3/3, alpha={'d5': -4.1, 'd10': 0.71, 'd20': None}, positiveAlpha={'d5': 0.333, 'd10': 0.5, 'd20': None}
- production_lane:legacy_recorded:left_side: n=26/26, alpha={'d5': 1.18, 'd10': 3.02, 'd20': 6.37}, positiveAlpha={'d5': 0.615, 'd10': 0.731, 'd20': 0.68}
- production_lane:legacy_recorded:pullback: n=41/41, alpha={'d5': -2.77, 'd10': -6.15, 'd20': 1.6}, positiveAlpha={'d5': 0.317, 'd10': 0.317, 'd20': 0.513}
- production_lane:legacy_recorded:strength: n=59/59, alpha={'d5': 1.67, 'd10': 1.44, 'd20': -1.21}, positiveAlpha={'d5': 0.621, 'd10': 0.586, 'd20': 0.526}
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 14.78, 'd10': None, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': None, 'd20': None}
- production_lane_status:integrity_v1_unversioned:strength:STRONG_PASS: n=3/3, alpha={'d5': -4.1, 'd10': 0.71, 'd20': None}, positiveAlpha={'d5': 0.333, 'd10': 0.5, 'd20': None}
- production_lane_status:legacy_recorded:left_side:STAGE2_PASS: n=19/19, alpha={'d5': 2.19, 'd10': 4.7, 'd20': 9.77}, positiveAlpha={'d5': 0.632, 'd10': 0.737, 'd20': 0.778}
...
- production_lane_status:legacy_recorded:pullback:PASS: n=20/20, alpha={'d5': -3.4, 'd10': -4.82, 'd20': 1.74}, positiveAlpha={'d5': 0.3, 'd10': 0.4, 'd20': 0.632}
- production_lane_status:legacy_recorded:pullback:STRONG_PASS: n=20/20, alpha={'d5': -2.31, 'd10': -6.58, 'd20': 2.65}, positiveAlpha={'d5': 0.3, 'd10': 0.25, 'd20': 0.421}
...
- production_lane_status:legacy_recorded:strength:STRONG_PASS: n=56/56, alpha={'d5': 2.18, 'd10': 1.67, 'd20': -0.82}, positiveAlpha={'d5': 0.636, 'd10': 0.6, 'd20': 0.537}
- shadow:left_side_context_v1: n=24/26, alpha={'d5': 7.5, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.583, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=39/42, alpha={'d5': 2.37, 'd10': 7.33, 'd20': None}, positiveAlpha={'d5': 0.586, 'd10': 0.812, 'd20': None}

## Decision And Abstention Audit
- snapshots: 67
- abstentions: {'MISSED_OPPORTUNITY': 16, 'PENDING': 3, 'DEGRADED_DATA': 1}
- D20 selected nonpositive alpha: 54
- D20 rejected positive alpha: 443
- avg D20 opportunity cost: 9.15
- avg D20 ex-post upper-bound gap: 24.19
...
- 2026-06-22 294400.KS FAILED_FAST D20=None alphaD20=None MFE=1.67 MAE=-27.1 bought=False lane=strength catalyst=
...
- 2026-08-04 ZS WINNER D20=None alphaD20=None MFE=17.56 MAE=-0.04 bought=False lane=left_side catalyst=
- 2026-08-10 GFI PENDING D20=None alphaD20=None MFE=5.07 MAE=-1.61 bought=False lane=left_side catalyst=
- 2026-08-10 EQX PENDING D20=None alphaD20=None MFE=4.96 MAE=-2.78 bought=False lane=left_side catalyst=
- 2026-08-11 CDE PENDING D20=None alphaD20=None MFE=6.2 MAE=-0.66 bought=False lane=left_side catalyst=
- 2026-08-12 CMCSA PENDING D20=None alphaD20=None MFE=0.35 MAE=-1.84 bought=False lane=left_side catalyst=
- 2026-08-12 RCI PENDING D20=None alphaD20=None MFE=1.88 MAE=-0.54 bought=False lane=left_side catalyst=
