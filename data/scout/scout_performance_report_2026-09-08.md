...
- left_side: n=32, avgD20=2.21, avgAlphaD20=6.59, winner=0.5, failed_fast=0.406, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=-2.54, avgAlphaD20=-3.54, winner=0.667, failed_fast=0.167, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-1.34, avgAlphaD20=2.08, winner=0.458, failed_fast=0.458, bought=0
...
- MIXED: n=36, avgD20=-1.28, avgAlphaD20=-0.32, winner=0.472, failed_fast=0.472, bought=0
- BULL: n=23, avgD20=4.79, avgAlphaD20=2.19, winner=0.565, failed_fast=0.304, bought=0
- NEGATIVE: n=22, avgD20=-11.7, avgAlphaD20=-0.1, winner=0.182, failed_fast=0.773, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.32, avgD20=13.16, alphaD20=11.69
- pre_entry_v1: n=36/42, avgD5=-0.74, avgD10=-2.07, avgD20=None, alphaD20=None
- us_precision_v1: n=57/60, avgD5=1.56, avgD10=2.96, avgD20=5.01, alphaD20=2.31

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=86/203, target=56, stop=30, late=58, avgR=0.04
- confirmed_swings_v1: resolved=122/441, target=46, stop=76, late=41, avgR=-0.32
- prominence_reaction_v2: resolved=87/203, target=52, stop=35, late=60, avgR=0.03
- rolling_extrema_v1: resolved=32/203, target=5, stop=27, late=1, avgR=-0.76

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=262/267, alpha={'d5': 0.53, 'd10': 0.97, 'd20': 5.75}, positiveAlpha={'d5': 0.56, 'd10': 0.604, 'd20': 0.625}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.04, 'd20': 11.69}, positiveAlpha={'d5': 0.514, 'd10': 0.6, 'd20': 0.75}
- shadow:pre_entry_v1: n=36/42, alpha={'d5': -0.41, 'd10': -1.62, 'd20': None}, positiveAlpha={'d5': 0.417, 'd10': 0.5, 'd20': None}
- shadow:us_precision_v1: n=57/60, alpha={'d5': 1.0, 'd10': 1.58, 'd20': 2.31}, positiveAlpha={'d5': 0.538, 'd10': 0.604, 'd20': 0.586}

## Decision And Abstention Audit
- snapshots: 89
- abstentions: {'MISSED_OPPORTUNITY': 31, 'DEGRADED_DATA': 2, 'GOOD_ABSTENTION': 1, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 703
- avg D20 opportunity cost: 8.81
- avg D20 ex-post upper-bound gap: 29.4
