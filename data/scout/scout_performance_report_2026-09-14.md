...
- pre_entry_v1: n=48/52, avgD5=-0.96, avgD10=-1.59, avgD20=None, alphaD20=None
- us_precision_v1: n=67/68, avgD5=1.39, avgD10=2.29, avgD20=2.77, alphaD20=1.35

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=105/255, target=66, stop=39, late=73, avgR=-0.02
- confirmed_swings_v1: resolved=159/570, target=67, stop=92, late=48, avgR=-0.25
- prominence_reaction_v2: resolved=119/255, target=71, stop=48, late=74, avgR=0.0
- rolling_extrema_v1: resolved=49/255, target=6, stop=43, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=275/282, alpha={'d5': 0.45, 'd10': 0.88, 'd20': 5.0}, positiveAlpha={'d5': 0.563, 'd10': 0.585, 'd20': 0.605}
...
- shadow:pre_entry_v1: n=48/52, alpha={'d5': -0.64, 'd10': -1.19, 'd20': None}, positiveAlpha={'d5': 0.353, 'd10': 0.545, 'd20': None}
- shadow:us_precision_v1: n=67/68, alpha={'d5': 0.92, 'd10': 0.98, 'd20': 1.35}, positiveAlpha={'d5': 0.526, 'd10': 0.569, 'd20': 0.548}

## Decision And Abstention Audit
- snapshots: 94
- abstentions: {'MISSED_OPPORTUNITY': 36, 'DEGRADED_DATA': 2, 'PENDING': 9}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 759
- avg D20 opportunity cost: 7.97
- avg D20 ex-post upper-bound gap: 30.2
