...
- date: 2026-07-01
- evaluated candidates: 87 / 90
- actually bought: 0
- avg D20 return: 0.75
- verdicts: {'FAILED_FAST': 43, 'WINNER': 18, 'WATCH': 8, 'PENDING': 18}

## Aggregates

### by_lane
- strength: n=52, avgD20=-0.8, winner=0.25, failed_fast=0.423, bought=0
- pullback: n=24, avgD20=17.86, winner=0.125, failed_fast=0.75, bought=0
- left_side: n=11, avgD20=None, winner=0.182, failed_fast=0.273, bought=0

### by_lane_status
- STRONG_PASS: n=65, avgD20=0.75, winner=0.246, failed_fast=0.492, bought=0
...
### by_theme_industry
- SUPPORT: n=46, avgD20=3.86, winner=0.37, failed_fast=0.304, bought=0
- NO_MAPPING: n=26, avgD20=None, winner=0.0, failed_fast=0.923, bought=0
- STRONG_SUPPORT: n=13, avgD20=-14.75, winner=0.0, failed_fast=0.385, bought=0
- SECTOR_UNSUPPORTED: n=2, avgD20=None, winner=0.5, failed_fast=0.0, bought=0

### by_quality_auditor
- STRONG_QUALITY: n=36, avgD20=-1.58, winner=0.306, failed_fast=0.361, bought=0
- QUALITY_SUPPORT: n=25, avgD20=7.75, winner=0.24, failed_fast=0.48, bought=0
- not_checked: n=15, avgD20=None, winner=0.067, failed_fast=0.533, bought=0
- NEUTRAL: n=9, avgD20=None, winner=0.0, failed_fast=0.889, bought=0
- DATA_LIGHT: n=2, avgD20=None, winner=0.0, failed_fast=1.0, bought=0

### by_catalyst
- unknown: n=36, avgD20=0.8, winner=0.306, failed_fast=0.444, bought=0
- POSITIVE_REVALUATION: n=27, avgD20=-0.02, winner=0.148, failed_fast=0.481, bought=0
- NOISE: n=19, avgD20=3.4, winner=0.158, failed_fast=0.526, bought=0
- NO_DATA: n=5, avgD20=None, winner=0.0, failed_fast=0.8, bought=0

## LLM Override Comparison
- counts: dropped=7, added=16, kept=74
- avg D5: dropped=-3.01, added=-1.82, kept=-1.54
- avg D20: dropped=-3.67, added=-1.72, kept=1.58
...
- 2026-06-13 MNST WINNER D5=0.49 D20=None MFE=4.98 MAE=-2.43 lane=strength:STRONG_PASS
- 2026-06-19 ALAB FAILED_FAST D5=3.71 D20=None MFE=13.61 MAE=-15.28 lane=strength:STRONG_PASS
- 2026-06-24 NUVL PENDING D5=None D20=None MFE=0.09 MAE=-0.12 lane=strength:STRONG_PASS
- 2026-06-27 DELL PENDING D5=None D20=None MFE=4.55 MAE=-8.67 lane=pullback:PASS
...
- 2026-06-13 IRDM FAILED_FAST D5=-2.71 D20=None MFE=22.08 MAE=-10.55 lane=strength:PASS
...
- 2026-06-19 WMT WATCH D5=-2.2 D20=None MFE=2.75 MAE=-3.63 lane=pullback:PASS
...
- 2026-05-30 RRX WINNER D20=17.86 MFE=18.25 MAE=-5.59 bought=False lane=pullback catalyst=
...
- 2026-06-09 AD FAILED_FAST D20=None MFE=3.52 MAE=-30.73 bought=False lane=left_side catalyst=POSITIVE_REVALUATION
...
- 2026-06-13 IRDM FAILED_FAST D20=None MFE=22.08 MAE=-10.55 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-06-13 CSCO WATCH D20=None MFE=2.26 MAE=-6.08 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-06-15 MNST WINNER D20=None MFE=4.98 MAE=-2.43 bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-06-19 WMT WATCH D20=None MFE=2.75 MAE=-3.63 bought=False lane=pullback catalyst=POSITIVE_REVALUATION
- 2026-06-19 FFIV WINNER D20=None MFE=9.17 MAE=-2.45 bought=False lane=strength catalyst=
- 2026-06-19 TRGP WATCH D20=None MFE=4.19 MAE=-3.07 bought=False lane=strength catalyst=
- 2026-06-20 420770.KQ FAILED_FAST D20=None MFE=21.23 MAE=-11.43 bought=False lane=strength catalyst=
...
- 2026-06-23 TW FAILED_FAST D20=None MFE=1.6 MAE=-7.82 bought=False lane=left_side catalyst=POSITIVE_REVALUATION
...
- 2026-06-25 TRGP PENDING D20=None MFE=0.78 MAE=-2.9 bought=False lane=strength catalyst=
- 2026-06-26 HEI PENDING D20=None MFE=3.21 MAE=-2.61 bought=False lane=strength catalyst=
- 2026-06-26 PANW PENDING D20=None MFE=12.58 MAE=-4.67 bought=False lane=strength catalyst=NOISE
- 2026-06-26 ROKU PENDING D20=None MFE=2.34 MAE=-0.77 bought=False lane=strength catalyst=
- 2026-06-27 NU PENDING D20=None MFE=1.98 MAE=-1.45 bought=False lane=left_side catalyst=
- 2026-06-27 APD PENDING D20=None MFE=12.32 MAE=-0.46 bought=False lane=pullback catalyst=POSITIVE_REVALUATION
...
- 2026-06-29 FTNT PENDING D20=None MFE=2.35 MAE=-3.02 bought=False lane=strength catalyst=NOISE
- 2026-06-30 TSM PENDING D20=None MFE=0.3 MAE=-5.13 bought=False lane=strength catalyst=NOISE
- 2026-06-30 CRWD PENDING D20=None MFE=0.28 MAE=-3.96 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-06-30 PENG PENDING D20=None MFE=1.79 MAE=-11.91 bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-07-01 009150.KS PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=POSITIVE_REVALUATION
- 2026-07-01 TIGO PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=
- 2026-07-01 MRVL PENDING D20=None MFE=None MAE=None bought=False lane=strength catalyst=NOISE
