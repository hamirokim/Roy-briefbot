...
- date: 2026-06-19
- evaluated candidates: 57 / 60
- actually bought: 0
- avg D20 return: None
- verdicts: {'FAILED_FAST': 16, 'WINNER': 14, 'WATCH': 9, 'PENDING': 18}

## Aggregates

### by_lane
- strength: n=33, avgD20=None, winner=0.273, failed_fast=0.364, bought=0
- pullback: n=18, avgD20=None, winner=0.278, failed_fast=0.167, bought=0
- left_side: n=6, avgD20=None, winner=0.0, failed_fast=0.167, bought=0

### by_lane_status
- STRONG_PASS: n=47, avgD20=None, winner=0.277, failed_fast=0.298, bought=0
...
- NO_MAPPING: n=17, avgD20=None, winner=0.176, failed_fast=0.235, bought=0
...
- QUALITY_SUPPORT: n=14, avgD20=None, winner=0.286, failed_fast=0.357, bought=0
...
- NOISE: n=13, avgD20=None, winner=0.154, failed_fast=0.308, bought=0
- NO_DATA: n=2, avgD20=None, winner=0.0, failed_fast=0.0, bought=0

## LLM Override Comparison
- counts: dropped=5, added=12, kept=48
- avg D5: dropped=-6.42, added=2.04, kept=1.04
...
- 2026-06-13 MNST PENDING D5=None D20=None MFE=0.74 MAE=-2.42 lane=strength:STRONG_PASS
...
- 2026-05-29 VMI WINNER D5=2.69 D20=None MFE=11.48 MAE=-2.84 lane=strength:STRONG_PASS
...
- 2026-06-16 005940.KS PENDING D5=None D20=None MFE=2.28 MAE=-4.72 lane=pullback:PASS
- 2026-06-17 017670.KS PENDING D5=None D20=None MFE=1.01 MAE=-3.13 lane=pullback:STRONG_PASS
...
- 2026-05-29 VMI WINNER D20=None MFE=11.48 MAE=-2.84 bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-06-03 402340.KS FAILED_FAST D20=None MFE=27.7 MAE=-21.01 bought=False lane=strength catalyst=NOISE
- 2026-06-03 336260.KS FAILED_FAST D20=None MFE=4.49 MAE=-25.89 bought=False lane=pullback catalyst=POSITIVE_REVALUATION
- 2026-06-03 CMCSA WATCH D20=None MFE=5.19 MAE=-4.8 bought=False lane=left_side catalyst=
...
- 2026-06-12 005380.KS PENDING D20=None MFE=8.57 MAE=-1.15 bought=False lane=pullback catalyst=NOISE
...
- 2026-06-15 MNST PENDING D20=None MFE=0.74 MAE=-2.42 bought=False lane=strength catalyst=POSITIVE_REVALUATION
...
- 2026-06-16 010950.KS PENDING D20=None MFE=1.49 MAE=-8.06 bought=False lane=pullback catalyst=NO_DATA
- 2026-06-16 005940.KS PENDING D20=None MFE=2.28 MAE=-4.72 bought=False lane=pullback catalyst=NOISE
- 2026-06-16 005387.KS PENDING D20=None MFE=1.78 MAE=-5.14 bought=False lane=pullback catalyst=
- 2026-06-17 373220.KS PENDING D20=None MFE=1.32 MAE=-4.33 bought=False lane=pullback catalyst=NOISE
- 2026-06-17 005935.KS PENDING D20=None MFE=1.99 MAE=-4.64 bought=False lane=strength catalyst=NO_DATA
- 2026-06-17 017670.KS PENDING D20=None MFE=1.01 MAE=-3.13 bought=False lane=pullback catalyst=
- 2026-06-18 080220.KQ PENDING D20=None MFE=4.67 MAE=-9.52 bought=False lane=strength catalyst=NOISE
- 2026-06-18 034220.KS PENDING D20=None MFE=1.18 MAE=-1.48 bought=False lane=pullback catalyst=
