...
- actually bought: 0
- avg D20 return: -3.36
- avg alpha: {'d5': 0.24, 'd10': -0.34, 'd20': 1.16}
- positive alpha rate: {'d5': 0.545, 'd10': 0.55, 'd20': 0.545}
...
### by_lane
- strength: n=62, avgD20=-4.51, avgAlphaD20=-1.35, winner=0.355, failed_fast=0.565, bought=0
- pullback: n=41, avgD20=-5.2, avgAlphaD20=1.33, winner=0.268, failed_fast=0.732, bought=0
- left_side: n=32, avgD20=2.11, avgAlphaD20=6.38, winner=0.469, failed_fast=0.406, bought=0

### by_lane_status
- STRONG_PASS: n=79, avgD20=-3.89, avgAlphaD20=-0.06, winner=0.342, failed_fast=0.595, bought=0
- PASS: n=23, avgD20=-7.05, avgAlphaD20=0.09, winner=0.261, failed_fast=0.739, bought=0
...
- NO_MAPPING: n=37, avgD20=-12.9, avgAlphaD20=3.68, winner=0.027, failed_fast=0.973, bought=0
...
- not_checked: n=25, avgD20=-0.28, avgAlphaD20=1.88, winner=0.4, failed_fast=0.52, bought=0
- NEUTRAL: n=13, avgD20=-17.65, avgAlphaD20=-1.64, winner=0.077, failed_fast=0.923, bought=0
- DATA_LIGHT: n=3, avgD20=-13.86, avgAlphaD20=1.54, winner=0.0, failed_fast=1.0, bought=0

### by_catalyst
- unknown: n=59, avgD20=-1.65, avgAlphaD20=1.78, winner=0.441, failed_fast=0.475, bought=0
...
### by_market_regime
- BULL: n=64, avgD20=0.89, avgAlphaD20=2.71, winner=0.422, failed_fast=0.469, bought=0
- MIXED: n=51, avgD20=-3.81, avgAlphaD20=-0.11, winner=0.412, failed_fast=0.549, bought=0
- POSITIVE: n=12, avgD20=-11.84, avgAlphaD20=2.18, winner=0.0, failed_fast=1.0, bought=0
...
- avg D5: dropped=-1.26, added=-2.39, kept=-0.72
- avg D20: dropped=-9.89, added=-4.44, kept=-3.17
...
- 2026-07-15 426030.KS FAILED_FAST D5=-15.27 D20=-8.01 MFE=1.02 MAE=-19.12 lane=pullback:PASS

## Outcome Memory Comparison
- evidence status: COLLECTING_UNTOUCHED_WINDOW
- counterfactual proven: False
- winner declared: False
- NONE: n=131/131, alpha={'d5': 0.03, 'd10': -0.49, 'd20': 1.16}, positiveAlpha={'d5': 0.531, 'd10': 0.547, 'd20': 0.545}
- SUPPORT: n=4/4, alpha={'d5': 6.87, 'd10': 19.84, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}

## Precision Shadow Comparison
- left_side_context_v1: n=35/35, avgD5=5.2, avgD10=11.06, avgD20=None, alphaD20=None
- pre_entry_v1: n=10/12, avgD5=None, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=48/48, avgD5=2.4, avgD10=5.52, avgD20=4.33, alphaD20=0.99

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=9/30, target=7, stop=2, late=8, avgR=0.13
- confirmed_swings_v1: resolved=32/141, target=8, stop=24, late=7, avgR=-0.71
- prominence_reaction_v2: resolved=13/30, target=5, stop=8, late=8, avgR=-0.41
- rolling_extrema_v1: resolved=1/30, target=0, stop=1, late=0, avgR=-1.0

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=219/222, alpha={'d5': 0.88, 'd10': 1.63, 'd20': 5.51}, positiveAlpha={'d5': 0.6, 'd10': 0.615, 'd20': 0.603}
...
- production:legacy_recorded: n=126/126, alpha={'d5': 0.11, 'd10': -0.48, 'd20': 1.16}, positiveAlpha={'d5': 0.528, 'd10': 0.552, 'd20': 0.545}
...
- production_lane:legacy_recorded:strength: n=59/59, alpha={'d5': 1.67, 'd10': 1.43, 'd20': -1.35}, positiveAlpha={'d5': 0.621, 'd10': 0.603, 'd20': 0.526}
...
- production_lane_status:legacy_recorded:strength:STRONG_PASS: n=56/56, alpha={'d5': 2.18, 'd10': 1.74, 'd20': -0.99}, positiveAlpha={'d5': 0.636, 'd10': 0.618, 'd20': 0.537}
- shadow:left_side_context_v1: n=35/35, alpha={'d5': 4.18, 'd10': 9.06, 'd20': None}, positiveAlpha={'d5': 0.5, 'd10': 0.714, 'd20': None}
- shadow:pre_entry_v1: n=10/12, alpha={'d5': None, 'd10': None, 'd20': None}, positiveAlpha={'d5': None, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=48/48, alpha={'d5': 1.42, 'd10': 2.57, 'd20': 0.99}, positiveAlpha={'d5': 0.548, 'd10': 0.586, 'd20': 0.333}

## Decision And Abstention Audit
- snapshots: 74
- abstentions: {'MISSED_OPPORTUNITY': 18, 'GOOD_ABSTENTION': 1, 'DEGRADED_DATA': 1, 'PENDING': 7}
- D20 selected nonpositive alpha: 56
- D20 rejected positive alpha: 481
- avg D20 opportunity cost: 8.62
- avg D20 ex-post upper-bound gap: 24.5
...
- 2026-06-22 294400.KS FAILED_FAST D20=-4.19 alphaD20=None MFE=1.67 MAE=-27.1 bought=False lane=strength catalyst=
...
- 2026-07-15 426030.KS FAILED_FAST D20=-8.01 alphaD20=None MFE=1.02 MAE=-19.12 bought=False lane=pullback catalyst=
...
- 2026-08-10 GFI WINNER D20=None alphaD20=None MFE=12.98 MAE=-2.9 bought=False lane=left_side catalyst=
- 2026-08-10 EQX WINNER D20=None alphaD20=None MFE=12.61 MAE=-3.65 bought=False lane=left_side catalyst=
- 2026-08-11 CDE WINNER D20=None alphaD20=None MFE=19.37 MAE=-0.66 bought=False lane=left_side catalyst=
