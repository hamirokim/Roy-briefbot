...
### by_market_regime
- BULL: n=60, avgD20=2.05, avgAlphaD20=2.2, winner=0.483, failed_fast=0.433, bought=0
...
- pre_entry_v1: n=24/26, avgD5=-0.73, avgD10=-5.47, avgD20=None, alphaD20=None
- us_precision_v1: n=52/53, avgD5=2.1, avgD10=3.27, avgD20=6.37, alphaD20=3.18

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=44/94, target=27, stop=17, late=23, avgR=-0.03
- confirmed_swings_v1: resolved=72/283, target=23, stop=49, late=18, avgR=-0.47
- prominence_reaction_v2: resolved=48/94, target=29, stop=19, late=22, avgR=0.14
- rolling_extrema_v1: resolved=7/94, target=2, stop=5, late=1, avgR=-0.52

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=237/243, alpha={'d5': 0.68, 'd10': 1.22, 'd20': 5.61}, positiveAlpha={'d5': 0.573, 'd10': 0.606, 'd20': 0.623}
...
- shadow:pre_entry_v1: n=24/26, alpha={'d5': 0.0, 'd10': -4.29, 'd20': None}, positiveAlpha={'d5': 0.5, 'd10': 0.5, 'd20': None}
- shadow:us_precision_v1: n=52/53, alpha={'d5': 1.5, 'd10': 1.6, 'd20': 3.18}, positiveAlpha={'d5': 0.583, 'd10': 0.581, 'd20': 0.55}

## Decision And Abstention Audit
- snapshots: 81
- abstentions: {'MISSED_OPPORTUNITY': 26, 'DEGRADED_DATA': 2, 'PENDING': 6}
