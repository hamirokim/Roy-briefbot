...
### by_market_regime
- BULL: n=59, avgD20=2.82, avgAlphaD20=2.59, winner=0.492, failed_fast=0.424, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.53, avgD20=7.94, alphaD20=7.42
- pre_entry_v1: n=46/50, avgD5=-0.88, avgD10=-1.33, avgD20=None, alphaD20=None
- us_precision_v1: n=66/67, avgD5=1.39, avgD10=2.29, avgD20=2.98, alphaD20=1.34

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=102/248, target=63, stop=39, late=71, avgR=-0.03
- confirmed_swings_v1: resolved=154/548, target=64, stop=90, late=47, avgR=-0.27
- prominence_reaction_v2: resolved=116/248, target=68, stop=48, late=73, avgR=-0.0
- rolling_extrema_v1: resolved=47/248, target=6, stop=41, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=273/279, alpha={'d5': 0.46, 'd10': 0.9, 'd20': 5.19}, positiveAlpha={'d5': 0.562, 'd10': 0.584, 'd20': 0.614}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.27, 'd20': 7.42}, positiveAlpha={'d5': 0.514, 'd10': 0.611, 'd20': 0.625}
- shadow:pre_entry_v1: n=46/50, alpha={'d5': -0.58, 'd10': -0.95, 'd20': None}, positiveAlpha={'d5': 0.375, 'd10': 0.55, 'd20': None}
- shadow:us_precision_v1: n=66/67, alpha={'d5': 0.92, 'd10': 0.98, 'd20': 1.34}, positiveAlpha={'d5': 0.526, 'd10': 0.569, 'd20': 0.513}

## Decision And Abstention Audit
- snapshots: 93
- abstentions: {'MISSED_OPPORTUNITY': 35, 'DEGRADED_DATA': 2, 'PENDING': 9}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 754
- avg D20 opportunity cost: 8.09
- avg D20 ex-post upper-bound gap: 28.73
