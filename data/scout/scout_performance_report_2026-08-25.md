...
- actually bought: 0
- avg D20 return: -3.51
- avg alpha: {'d5': 0.31, 'd10': -0.27, 'd20': 1.28}
- positive alpha rate: {'d5': 0.545, 'd10': 0.542, 'd20': 0.552}
- verdicts: {'FAILED_FAST': 77, 'WINNER': 48, 'NEUTRAL': 7, 'PENDING': 1, 'WATCH': 2}
...
- left_side: n=32, avgD20=1.68, avgAlphaD20=6.23, winner=0.469, failed_fast=0.406, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=-5.62, avgAlphaD20=-6.77, winner=0.583, failed_fast=0.167, bought=0
...
### by_theme_industry
- SUPPORT: n=66, avgD20=1.04, avgAlphaD20=0.78, winner=0.5, failed_fast=0.364, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=56, avgD20=2.23, avgAlphaD20=3.39, winner=0.429, failed_fast=0.446, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-1.97, avgAlphaD20=1.65, winner=0.441, failed_fast=0.458, bought=0
...
### by_market_regime
- BULL: n=61, avgD20=1.61, avgAlphaD20=2.22, winner=0.443, failed_fast=0.443, bought=0
- MIXED: n=49, avgD20=-2.81, avgAlphaD20=0.73, winner=0.429, failed_fast=0.51, bought=0
- POSITIVE: n=16, avgD20=-14.02, avgAlphaD20=2.57, winner=0.0, failed_fast=1.0, bought=0
- NEGATIVE: n=7, avgD20=-16.1, avgAlphaD20=-2.42, winner=0.0, failed_fast=1.0, bought=0
- BEAR: n=2, avgD20=-29.88, avgAlphaD20=-8.84, winner=0.0, failed_fast=1.0, bought=0
...
- NONE: n=131/131, alpha={'d5': 0.1, 'd10': -0.43, 'd20': 1.28}, positiveAlpha={'d5': 0.531, 'd10': 0.538, 'd20': 0.552}
- SUPPORT: n=4/4, alpha={'d5': 6.87, 'd10': 19.84, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}

## Precision Shadow Comparison
- left_side_context_v1: n=35/36, avgD5=3.58, avgD10=9.91, avgD20=None, alphaD20=None
- pre_entry_v1: n=16/18, avgD5=-0.9, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=51/51, avgD5=2.14, avgD10=4.36, avgD20=10.12, alphaD20=7.02

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=15/58, target=10, stop=5, late=15, avgR=-0.06
- confirmed_swings_v1: resolved=38/207, target=10, stop=28, late=15, avgR=-0.68
- prominence_reaction_v2: resolved=18/58, target=9, stop=9, late=14, avgR=-0.15
- rolling_extrema_v1: resolved=1/58, target=0, stop=1, late=1, avgR=-1.0

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=228/231, alpha={'d5': 0.66, 'd10': 1.56, 'd20': 5.98}, positiveAlpha={'d5': 0.574, 'd10': 0.622, 'd20': 0.632}
- production:integrity_v1: n=6/6, alpha={'d5': 5.46, 'd10': 19.69, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 5.46, 'd10': 19.69, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 5.46, 'd10': 19.69, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- shadow:left_side_context_v1: n=35/36, alpha={'d5': 2.95, 'd10': 8.7, 'd20': None}, positiveAlpha={'d5': 0.516, 'd10': 0.7, 'd20': None}
- shadow:pre_entry_v1: n=16/18, alpha={'d5': 0.75, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.667, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=51/51, alpha={'d5': 1.52, 'd10': 1.89, 'd20': 7.02}, positiveAlpha={'d5': 0.574, 'd10': 0.576, 'd20': 0.714}

## Decision And Abstention Audit
- snapshots: 77
- abstentions: {'MISSED_OPPORTUNITY': 22, 'DEGRADED_DATA': 2, 'PENDING': 6}
- D20 selected nonpositive alpha: 56
- D20 rejected positive alpha: 583
- avg D20 opportunity cost: 7.97
- avg D20 ex-post upper-bound gap: 26.66
...
- 2026-08-10 GFI WINNER D20=None alphaD20=None MFE=19.81 MAE=-2.9 bought=False lane=left_side catalyst=
- 2026-08-10 EQX WINNER D20=None alphaD20=None MFE=20.96 MAE=-3.65 bought=False lane=left_side catalyst=
- 2026-08-11 CDE WINNER D20=None alphaD20=None MFE=21.08 MAE=-0.66 bought=False lane=left_side catalyst=
- 2026-08-12 CMCSA WATCH D20=None alphaD20=None MFE=6.42 MAE=-1.84 bought=False lane=left_side catalyst=
