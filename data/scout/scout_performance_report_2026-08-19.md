...
- actually bought: 0
- avg D20 return: -3.5
- avg alpha: {'d5': 0.24, 'd10': -0.56, 'd20': 1.29}
- positive alpha rate: {'d5': 0.538, 'd10': 0.535, 'd20': 0.552}
- verdicts: {'FAILED_FAST': 77, 'WINNER': 46, 'NEUTRAL': 7, 'PENDING': 3, 'WATCH': 2}
...
- left_side: n=32, avgD20=1.75, avgAlphaD20=6.3, winner=0.406, failed_fast=0.406, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=-5.62, avgAlphaD20=-6.77, winner=0.417, failed_fast=0.167, bought=0
...
### by_theme_industry
- SUPPORT: n=66, avgD20=1.06, avgAlphaD20=0.81, winner=0.47, failed_fast=0.364, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=56, avgD20=2.23, avgAlphaD20=3.39, winner=0.393, failed_fast=0.446, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-1.94, avgAlphaD20=1.69, winner=0.407, failed_fast=0.458, bought=0
...
### by_market_regime
- BULL: n=71, avgD20=-0.85, avgAlphaD20=2.9, winner=0.352, failed_fast=0.521, bought=0
- MIXED: n=50, avgD20=-3.31, avgAlphaD20=0.64, winner=0.42, failed_fast=0.52, bought=0
...
- avg D5: dropped=-1.26, added=-1.81, kept=-0.6
...
- NONE: n=131/131, alpha={'d5': 0.1, 'd10': -0.72, 'd20': 1.29}, positiveAlpha={'d5': 0.531, 'd10': 0.531, 'd20': 0.552}
- SUPPORT: n=4/4, alpha={'d5': 9.06, 'd10': 19.84, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}

## Precision Shadow Comparison
- left_side_context_v1: n=33/35, avgD5=5.53, avgD10=8.04, avgD20=None, alphaD20=None
- pre_entry_v1: n=6/8, avgD5=None, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=48/48, avgD5=2.84, avgD10=4.85, avgD20=4.1, alphaD20=0.76

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=0/8, target=0, stop=0, late=2, avgR=None
- confirmed_swings_v1: resolved=18/95, target=3, stop=15, late=2, avgR=-0.81
- prominence_reaction_v2: resolved=3/8, target=2, stop=1, late=1, avgR=-0.07
- rolling_extrema_v1: resolved=0/8, target=0, stop=0, late=0, avgR=None

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=213/216, alpha={'d5': 0.91, 'd10': 1.36, 'd20': 5.95}, positiveAlpha={'d5': 0.589, 'd10': 0.614, 'd20': 0.638}
- production:integrity_v1: n=6/6, alpha={'d5': 5.85, 'd10': 19.84, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 5.85, 'd10': 19.84, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 5.85, 'd10': 19.84, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- shadow:left_side_context_v1: n=33/35, alpha={'d5': 4.05, 'd10': 4.64, 'd20': None}, positiveAlpha={'d5': 0.5, 'd10': 0.7, 'd20': None}
- shadow:pre_entry_v1: n=6/8, alpha={'d5': None, 'd10': None, 'd20': None}, positiveAlpha={'d5': None, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=48/48, alpha={'d5': 1.61, 'd10': 1.88, 'd20': 0.76}, positiveAlpha={'d5': 0.556, 'd10': 0.586, 'd20': 0.333}

## Decision And Abstention Audit
- snapshots: 72
- abstentions: {'MISSED_OPPORTUNITY': 19, 'DEGRADED_DATA': 1, 'PENDING': 5}
- D20 selected nonpositive alpha: 56
- D20 rejected positive alpha: 488
- avg D20 opportunity cost: 8.81
- avg D20 ex-post upper-bound gap: 24.72
...
- 2026-08-04 ZS WINNER D20=None alphaD20=None MFE=24.14 MAE=-0.04 bought=False lane=left_side catalyst=
- 2026-08-10 GFI WATCH D20=None alphaD20=None MFE=5.08 MAE=-2.9 bought=False lane=left_side catalyst=
- 2026-08-10 EQX WATCH D20=None alphaD20=None MFE=4.96 MAE=-3.65 bought=False lane=left_side catalyst=
- 2026-08-11 CDE WINNER D20=None alphaD20=None MFE=8.69 MAE=-0.66 bought=False lane=left_side catalyst=
- 2026-08-12 CMCSA PENDING D20=None alphaD20=None MFE=3.72 MAE=-1.84 bought=False lane=left_side catalyst=
- 2026-08-12 RCI PENDING D20=None alphaD20=None MFE=4.29 MAE=-0.54 bought=False lane=left_side catalyst=
