...
- actually bought: 0
- avg D20 return: -3.04
- avg alpha: {'d5': 0.31, 'd10': -0.01, 'd20': 1.46}
- positive alpha rate: {'d5': 0.545, 'd10': 0.552, 'd20': 0.557}
...
- left_side: n=32, avgD20=2.98, avgAlphaD20=7.12, winner=0.5, failed_fast=0.406, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=1.0, avgAlphaD20=0.41, winner=0.667, failed_fast=0.167, bought=0
...
### by_theme_industry
- SUPPORT: n=66, avgD20=1.15, avgAlphaD20=0.82, winner=0.515, failed_fast=0.364, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=56, avgD20=2.4, avgAlphaD20=3.46, winner=0.446, failed_fast=0.446, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-0.82, avgAlphaD20=2.51, winner=0.458, failed_fast=0.458, bought=0
...
- NEGATIVE: n=32, avgD20=-6.72, avgAlphaD20=2.07, winner=0.312, failed_fast=0.594, bought=0
- MIXED: n=26, avgD20=-3.4, avgAlphaD20=-3.07, winner=0.423, failed_fast=0.577, bought=0
- BULL: n=23, avgD20=5.7, avgAlphaD20=3.46, winner=0.565, failed_fast=0.304, bought=0

## LLM Override Comparison
- counts: dropped=7, added=19, kept=116
- avg D5: dropped=-1.26, added=-1.81, kept=-0.52
- avg D20: dropped=-9.89, added=-4.38, kept=-2.81
...
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.32, avgD20=10.16, alphaD20=9.16
- pre_entry_v1: n=42/46, avgD5=-0.85, avgD10=-1.62, avgD20=None, alphaD20=None
- us_precision_v1: n=60/66, avgD5=1.41, avgD10=2.29, avgD20=4.36, alphaD20=2.09

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=99/230, target=63, stop=36, late=66, avgR=-0.0
- confirmed_swings_v1: resolved=137/501, target=53, stop=84, late=45, avgR=-0.3
- prominence_reaction_v2: resolved=96/230, target=58, stop=38, late=68, avgR=0.06
- rolling_extrema_v1: resolved=33/230, target=6, stop=27, late=1, avgR=-0.74

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=267/273, alpha={'d5': 0.51, 'd10': 0.88, 'd20': 5.34}, positiveAlpha={'d5': 0.559, 'd10': 0.588, 'd20': 0.613}
- production:integrity_v1: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 14.77}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 14.77}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 14.77}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.04, 'd20': 9.16}, positiveAlpha={'d5': 0.514, 'd10': 0.6, 'd20': 0.65}
- shadow:pre_entry_v1: n=42/46, alpha={'d5': -0.54, 'd10': -1.32, 'd20': None}, positiveAlpha={'d5': 0.393, 'd10': 0.562, 'd20': None}
- shadow:us_precision_v1: n=60/66, alpha={'d5': 0.87, 'd10': 0.98, 'd20': 2.09}, positiveAlpha={'d5': 0.519, 'd10': 0.569, 'd20': 0.545}

## Decision And Abstention Audit
- snapshots: 91
- abstentions: {'MISSED_OPPORTUNITY': 33, 'DEGRADED_DATA': 2, 'PENDING': 9}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 725
- avg D20 opportunity cost: 8.35
- avg D20 ex-post upper-bound gap: 29.22
