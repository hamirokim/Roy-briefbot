...
- left_side_context_v1: n=37/37, avgD5=2.6, avgD10=7.02, avgD20=5.67, alphaD20=1.64
- pre_entry_v1: n=24/28, avgD5=-0.73, avgD10=-5.47, avgD20=None, alphaD20=None
- us_precision_v1: n=52/54, avgD5=2.1, avgD10=3.27, avgD20=6.37, alphaD20=3.18

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=45/111, target=28, stop=17, late=27, avgR=-0.03
- confirmed_swings_v1: resolved=76/300, target=23, stop=53, late=22, avgR=-0.5
- prominence_reaction_v2: resolved=51/111, target=29, stop=22, late=24, avgR=0.07
- rolling_extrema_v1: resolved=7/111, target=2, stop=5, late=1, avgR=-0.52

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=242/246, alpha={'d5': 0.7, 'd10': 1.22, 'd20': 5.61}, positiveAlpha={'d5': 0.577, 'd10': 0.606, 'd20': 0.623}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.09, 'd10': 6.44, 'd20': 1.64}, positiveAlpha={'d5': 0.486, 'd10': 0.679, 'd20': 0.75}
- shadow:pre_entry_v1: n=24/28, alpha={'d5': 0.0, 'd10': -4.29, 'd20': None}, positiveAlpha={'d5': 0.5, 'd10': 0.5, 'd20': None}
- shadow:us_precision_v1: n=52/54, alpha={'d5': 1.5, 'd10': 1.6, 'd20': 3.18}, positiveAlpha={'d5': 0.583, 'd10': 0.581, 'd20': 0.55}

## Decision And Abstention Audit
- snapshots: 82
- abstentions: {'MISSED_OPPORTUNITY': 27, 'DEGRADED_DATA': 2, 'PENDING': 6}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 629
- avg D20 opportunity cost: 8.77
- avg D20 ex-post upper-bound gap: 27.1
...
- 2026-08-12 RCI WINNER D20=None alphaD20=None MFE=5.66 MAE=-0.54 bought=False lane=left_side catalyst=
