...
- pre_entry_v1: n=58/62, avgD5=-1.05, avgD10=-2.01, avgD20=-4.95, alphaD20=-2.92
- us_precision_v1: n=74/77, avgD5=0.77, avgD10=2.12, avgD20=2.44, alphaD20=1.49

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=126/301, target=76, stop=50, late=85, avgR=0.01
- confirmed_swings_v1: resolved=194/685, target=81, stop=113, late=55, avgR=-0.23
- prominence_reaction_v2: resolved=144/301, target=84, stop=60, late=84, avgR=-0.02
- rolling_extrema_v1: resolved=73/301, target=9, stop=64, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=291/297, alpha={'d5': 0.32, 'd10': 0.51, 'd20': 4.42}, positiveAlpha={'d5': 0.555, 'd10': 0.562, 'd20': 0.595}
...
- shadow:pre_entry_v1: n=58/62, alpha={'d5': -0.53, 'd10': -1.42, 'd20': -2.92}, positiveAlpha={'d5': 0.37, 'd10': 0.406, 'd20': 0.375}
- shadow:us_precision_v1: n=74/77, alpha={'d5': 0.46, 'd10': 1.01, 'd20': 1.49}, positiveAlpha={'d5': 0.485, 'd10': 0.561, 'd20': 0.562}

## Decision And Abstention Audit
- snapshots: 99
- abstentions: {'MISSED_OPPORTUNITY': 42, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 812
- avg D20 opportunity cost: 7.95
- avg D20 ex-post upper-bound gap: 29.01
