...
- actually bought: 0
- avg D20 return: -3.51
- avg alpha: {'d5': 0.31, 'd10': -0.12, 'd20': 1.28}
- positive alpha rate: {'d5': 0.545, 'd10': 0.545, 'd20': 0.552}
...
- SUPPORT: n=4/4, alpha={'d5': 6.87, 'd10': 20.21, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}

## Precision Shadow Comparison
- left_side_context_v1: n=36/36, avgD5=3.24, avgD10=9.17, avgD20=None, alphaD20=None
- pre_entry_v1: n=18/20, avgD5=-0.9, avgD10=None, avgD20=None, alphaD20=None
- us_precision_v1: n=51/51, avgD5=2.1, avgD10=4.14, avgD20=10.12, alphaD20=7.02

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=19/69, target=14, stop=5, late=16, avgR=0.06
- confirmed_swings_v1: resolved=49/230, target=17, stop=32, late=16, avgR=-0.42
- prominence_reaction_v2: resolved=24/69, target=15, stop=9, late=15, avgR=0.05
- rolling_extrema_v1: resolved=1/69, target=0, stop=1, late=1, avgR=-1.0

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=231/234, alpha={'d5': 0.63, 'd10': 1.53, 'd20': 6.01}, positiveAlpha={'d5': 0.571, 'd10': 0.623, 'd20': 0.63}
- production:integrity_v1: n=6/6, alpha={'d5': 5.46, 'd10': 19.91, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 5.46, 'd10': 19.91, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 5.46, 'd10': 19.91, 'd20': None}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': None}
...
- shadow:left_side_context_v1: n=36/36, alpha={'d5': 2.66, 'd10': 8.17, 'd20': None}, positiveAlpha={'d5': 0.515, 'd10': 0.727, 'd20': None}
- shadow:pre_entry_v1: n=18/20, alpha={'d5': 0.75, 'd10': None, 'd20': None}, positiveAlpha={'d5': 0.667, 'd10': None, 'd20': None}
- shadow:us_precision_v1: n=51/51, alpha={'d5': 1.5, 'd10': 1.97, 'd20': 7.02}, positiveAlpha={'d5': 0.583, 'd10': 0.583, 'd20': 0.714}

## Decision And Abstention Audit
- snapshots: 78
- abstentions: {'MISSED_OPPORTUNITY': 23, 'DEGRADED_DATA': 2, 'PENDING': 6}
- D20 selected nonpositive alpha: 56
- D20 rejected positive alpha: 585
- avg D20 opportunity cost: 8.17
- avg D20 ex-post upper-bound gap: 26.4
...
- 2026-08-12 CMCSA WATCH D20=None alphaD20=None MFE=7.09 MAE=-1.84 bought=False lane=left_side catalyst=
