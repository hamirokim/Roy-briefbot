...
- left_side: n=32, avgD20=1.68, avgAlphaD20=6.23, winner=0.531, failed_fast=0.406, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=-5.62, avgAlphaD20=-6.77, winner=0.75, failed_fast=0.167, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-1.67, avgAlphaD20=1.82, winner=0.475, failed_fast=0.458, bought=0
...
### by_market_regime
- BULL: n=59, avgD20=1.99, avgAlphaD20=1.59, winner=0.492, failed_fast=0.424, bought=0
...
- left_side_context_v1: n=37/37, avgD5=2.6, avgD10=5.62, avgD20=6.76, alphaD20=3.57
- pre_entry_v1: n=28/30, avgD5=-0.83, avgD10=-2.83, avgD20=None, alphaD20=None
- us_precision_v1: n=54/54, avgD5=1.65, avgD10=3.04, avgD20=5.28, alphaD20=2.29

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=63/141, target=42, stop=21, late=35, avgR=0.06
- confirmed_swings_v1: resolved=92/344, target=34, stop=58, late=28, avgR=-0.4
- prominence_reaction_v2: resolved=60/141, target=34, stop=26, late=40, avgR=0.01
- rolling_extrema_v1: resolved=19/141, target=2, stop=17, late=1, avgR=-0.82

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=246/249, alpha={'d5': 0.68, 'd10': 1.04, 'd20': 5.83}, positiveAlpha={'d5': 0.573, 'd10': 0.598, 'd20': 0.624}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.09, 'd10': 5.2, 'd20': 3.57}, positiveAlpha={'d5': 0.486, 'd10': 0.645, 'd20': 0.625}
- shadow:pre_entry_v1: n=28/30, alpha={'d5': -0.35, 'd10': -1.65, 'd20': None}, positiveAlpha={'d5': 0.375, 'd10': 0.667, 'd20': None}
- shadow:us_precision_v1: n=54/54, alpha={'d5': 1.07, 'd10': 1.61, 'd20': 2.29}, positiveAlpha={'d5': 0.549, 'd10': 0.596, 'd20': 0.577}

## Decision And Abstention Audit
- snapshots: 83
- abstentions: {'MISSED_OPPORTUNITY': 27, 'DEGRADED_DATA': 2, 'PENDING': 7}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 659
- avg D20 opportunity cost: 8.71
- avg D20 ex-post upper-bound gap: 28.41
...
- 2026-08-12 RCI WINNER D20=None alphaD20=None MFE=5.91 MAE=-0.54 bought=False lane=left_side catalyst=
