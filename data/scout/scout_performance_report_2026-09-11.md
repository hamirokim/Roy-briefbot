...
- actually bought: 0
- avg D20 return: -2.89
- avg alpha: {'d5': 0.31, 'd10': -0.01, 'd20': 1.59}
- positive alpha rate: {'d5': 0.545, 'd10': 0.552, 'd20': 0.561}
...
- left_side: n=32, avgD20=3.42, avgAlphaD20=7.47, winner=0.5, failed_fast=0.406, bought=0
...
- STAGE2_STRONG_PASS: n=12, avgD20=2.52, avgAlphaD20=2.15, winner=0.667, failed_fast=0.167, bought=0
...
### by_theme_industry
- SUPPORT: n=66, avgD20=1.39, avgAlphaD20=1.09, winner=0.515, failed_fast=0.364, bought=0
...
### by_quality_auditor
- STRONG_QUALITY: n=56, avgD20=2.66, avgAlphaD20=3.73, winner=0.446, failed_fast=0.446, bought=0
...
### by_catalyst
- unknown: n=59, avgD20=-0.52, avgAlphaD20=2.78, winner=0.458, failed_fast=0.458, bought=0
...
### by_market_regime
- BULL: n=59, avgD20=2.9, avgAlphaD20=2.59, winner=0.475, failed_fast=0.424, bought=0
- MIXED: n=42, avgD20=-0.88, avgAlphaD20=-0.96, winner=0.476, failed_fast=0.452, bought=0
- POSITIVE: n=18, avgD20=-13.37, avgAlphaD20=4.34, winner=0.0, failed_fast=1.0, bought=0
- NEGATIVE: n=16, avgD20=-16.65, avgAlphaD20=1.67, winner=0.062, failed_fast=0.938, bought=0

## LLM Override Comparison
- counts: dropped=7, added=19, kept=116
- avg D5: dropped=-1.26, added=-1.81, kept=-0.52
- avg D20: dropped=-9.89, added=-4.38, kept=-2.64
...
- SUPPORT: n=4/4, alpha={'d5': 6.87, 'd10': 13.52, 'd20': 16.8}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}

## Precision Shadow Comparison
- left_side_context_v1: n=37/37, avgD5=2.63, avgD10=4.53, avgD20=9.01, alphaD20=8.24
- pre_entry_v1: n=44/48, avgD5=-0.85, avgD10=-1.3, avgD20=None, alphaD20=None
- us_precision_v1: n=63/67, avgD5=1.41, avgD10=2.29, avgD20=3.99, alphaD20=2.04

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=101/239, target=63, stop=38, late=69, avgR=-0.02
- confirmed_swings_v1: resolved=149/524, target=64, stop=85, late=45, avgR=-0.24
- prominence_reaction_v2: resolved=111/239, target=67, stop=44, late=72, avgR=0.03
- rolling_extrema_v1: resolved=43/239, target=6, stop=37, late=1, avgR=-0.8

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=270/276, alpha={'d5': 0.48, 'd10': 0.87, 'd20': 5.25}, positiveAlpha={'d5': 0.56, 'd10': 0.584, 'd20': 0.613}
- production:integrity_v1: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 15.52}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- production_lane:integrity_v1:left_side: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 15.52}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- production_lane_status:integrity_v1:left_side:STAGE2_STRONG_PASS: n=6/6, alpha={'d5': 5.46, 'd10': 15.55, 'd20': 15.52}, positiveAlpha={'d5': 1.0, 'd10': 1.0, 'd20': 1.0}
...
- shadow:left_side_context_v1: n=37/37, alpha={'d5': 2.17, 'd10': 4.27, 'd20': 8.24}, positiveAlpha={'d5': 0.514, 'd10': 0.611, 'd20': 0.636}
- shadow:pre_entry_v1: n=44/48, alpha={'d5': -0.57, 'd10': -0.97, 'd20': None}, positiveAlpha={'d5': 0.367, 'd10': 0.611, 'd20': None}
- shadow:us_precision_v1: n=63/67, alpha={'d5': 0.87, 'd10': 0.98, 'd20': 2.04}, positiveAlpha={'d5': 0.519, 'd10': 0.569, 'd20': 0.528}

## Decision And Abstention Audit
- snapshots: 92
- abstentions: {'MISSED_OPPORTUNITY': 33, 'DEGRADED_DATA': 2, 'GOOD_ABSTENTION': 1, 'PENDING': 9}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 741
- avg D20 opportunity cost: 8.22
- avg D20 ex-post upper-bound gap: 28.91
...
- 2026-08-12 CMCSA WATCH D20=None alphaD20=None MFE=7.09 MAE=-5.29 bought=False lane=left_side catalyst=
- 2026-08-12 RCI WINNER D20=None alphaD20=None MFE=8.24 MAE=-0.54 bought=False lane=left_side catalyst=
