...
### by_market_regime
- POSITIVE: n=60, avgD20=-2.85, avgAlphaD20=2.55, winner=0.317, failed_fast=0.633, bought=0
- NEGATIVE: n=55, avgD20=-5.48, avgAlphaD20=-0.02, winner=0.364, failed_fast=0.582, bought=0
- BULL: n=16, avgD20=5.88, avgAlphaD20=4.7, winner=0.625, failed_fast=0.312, bought=0
...
- pre_entry_v1: n=64/68, avgD5=-1.28, avgD10=-2.27, avgD20=-4.27, alphaD20=-2.98
- us_precision_v1: n=80/86, avgD5=0.96, avgD10=2.12, avgD20=2.44, alphaD20=1.49

## Support Resistance Engine Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- atr_reversal_v1: resolved=134/338, target=80, stop=54, late=100, avgR=-0.02
- confirmed_swings_v1: resolved=214/761, target=88, stop=126, late=66, avgR=-0.23
- prominence_reaction_v2: resolved=153/338, target=91, stop=62, late=102, avgR=0.01
- rolling_extrema_v1: resolved=81/338, target=9, stop=72, late=1, avgR=-0.84

## Policy Comparison
- evidence status: COLLECTING_FORWARD_EVIDENCE
- winner declared: False
- reason: 정책별 동일 기간의 만기 초과수익 표본을 축적 중이며 자동 승자 선언은 하지 않음
- baseline:radar_top3_not_selected: n=300/306, alpha={'d5': 0.26, 'd10': 0.2, 'd20': 4.25}, positiveAlpha={'d5': 0.548, 'd10': 0.544, 'd20': 0.596}
...
- shadow:pre_entry_v1: n=64/68, alpha={'d5': -0.95, 'd10': -1.72, 'd20': -2.98}, positiveAlpha={'d5': 0.346, 'd10': 0.361, 'd20': 0.417}
- shadow:us_precision_v1: n=80/86, alpha={'d5': 0.64, 'd10': 1.01, 'd20': 1.49}, positiveAlpha={'d5': 0.5, 'd10': 0.561, 'd20': 0.562}

## Decision And Abstention Audit
- snapshots: 102
- abstentions: {'MISSED_OPPORTUNITY': 45, 'DEGRADED_DATA': 2, 'PENDING': 8}
- D20 selected nonpositive alpha: 58
- D20 rejected positive alpha: 824
- avg D20 opportunity cost: 7.76
- avg D20 ex-post upper-bound gap: 28.35
