...
- `docs/SCOUT_TOP3_LLM_REVIEW.md` defines the proposed LLM final-review scope: rules engine narrows the pool, LLM reviews only the top 8-12 candidates plus market context.
